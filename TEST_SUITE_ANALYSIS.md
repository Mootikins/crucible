...
### Location
**File:** `./crucible/crates/crucible-parser/src/frontmatter.rs`
...
1. Add to `./crucible/crates/crucible-parser/src/lib.rs`:
   ```rust
   pub mod frontmatter;
...
- **Parser implementation:** `./crucible/crates/crucible-parser/src/implementation.rs` (lines 1-200)
- **Existing test patterns:** `./crucible/crates/crucible-parser/src/types.rs` (test module)
- **Agent tests (reference):** `./crucible/crates/crucible-core/src/agent/tests.rs` (865 lines)
- **Mock implementations:** `./crucible/crates/crucible-core/src/test_support/mocks.rs` (1,200+ lines)
- **Test utilities:** `./crucible/crates/crucible-core/src/test_support/mod.rs` (87 lines)

### Configuration Files
- **Parser Cargo.toml:** `./crucible/crates/crucible-parser/Cargo.toml`
- **Core Cargo.toml:** `./crucible/crates/crucible-core/Cargo.toml`

---

## 11. Next Steps

1. Create `./crucible/crates/crucible-parser/src/frontmatter.rs`
