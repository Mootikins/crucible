...
**Location**: `./crucible/crates/crucible-surrealdb/src/vault_integration.rs`
...
**Location**: `./crucible/crates/crucible-surrealdb/src/vault_processor.rs`
...
### Unit Tests
**File**: `./crucible/crates/crucible-surrealdb/tests/delta_processing_tests.rs`
...
The integration test `test_delta_processing_single_file_change` in `./crucible/crates/crucible-cli/tests/cli_daemon_integration.rs` is a TDD test that expects end-to-end integration through the CLI/daemon. This requires Phase 2 work to wire up the delta processing function to the daemon workflow.
...
- `./crucible/crates/crucible-surrealdb/src/vault_integration.rs`
  - Added `delete_document_embeddings()` function

- `./crucible/crates/crucible-surrealdb/src/vault_processor.rs`
...
- `./crucible/crates/crucible-surrealdb/src/lib.rs`
  - Exported `process_vault_delta` in public API

- `./crucible/crates/crucible-surrealdb/tests/delta_processing_tests.rs`
