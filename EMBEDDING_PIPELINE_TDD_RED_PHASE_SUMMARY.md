...
The TDD test file `./crucible/crates/crucible-cli/tests/embedding_pipeline_tdd.rs` contains **6 comprehensive tests** that all currently **FAIL** as expected, driving the implementation of proper integration between components.
