...
### 1. `./crucible/crates/crucible-core/src/storage/merkle.rs`
...
### 2. `./crucible/crates/crucible-core/src/hashing/file_hasher.rs`
- **Line ~15**: Removed module-level example showing `FileHasher` usage
- **Replacement**: `// TODO: Add example once API stabilizes`

### 3. `./crucible/crates/crucible-core/src/storage/factory.rs`
- **Line ~17**: Removed module-level usage example
- **Line ~501**: Removed `StorageFactory::create` example
- **Replacement**: `// TODO: Add example once API stabilizes`

### 4. `./crucible/crates/crucible-core/src/storage/builder.rs`
- **Line ~17**: Removed module-level usage example
- **Replacement**: `// TODO: Add example once API stabilizes`

### 5. `./crucible/crates/crucible-core/src/traits/change_detection.rs`
...
### 6. `./crucible/crates/crucible-core/src/types/hashing.rs`
