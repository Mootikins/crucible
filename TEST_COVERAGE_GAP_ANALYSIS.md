...
**Current Test File**: `./crucible/crates/crucible-tools/tests/vault_file_parsing_tests.rs` (724 lines)
...
**Current File**: `./crucible/crates/crucible-cli/tests/error_recovery_tdd.rs` (27 tests, 864 LOC)
