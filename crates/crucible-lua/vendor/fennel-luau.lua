...
package.preload["fennel.repl"] = package.preload["fennel.repl"] or function(...)
  local _805_ = require("fennel.utils")
  local utils = _805_
  local copy = _805_["copy"]
  ...
  local function default_on_error(errtype, err)
    local function _810_()
      local _809_0 = errtype
      if (_809_0 == "Runtime") then
  ...
  local function splice_save_locals(env, lua_source, scope)
    ...
    local function _819_()
      local _817_0, _818_0 = lua_source:match("^(.*)[\n ](return .*)$")
      if ((nil ~= _817_0) and (nil ~= _818_0)) then
        local body = _817_0
        local _return = _818_0
  ...
  local function completer(env, scope, text, _3ffulltext, _from, _to)
    ...
    local function add_partials(input, tbl, prefix)
      ...
      for k, is_mangled in utils.allpairs(_821_()) do
    ...
    do
      local _830_0 = tostring((_3ffulltext or text)):match("^%s*,([^%s()[%]]*)$")
      if (nil ~= _830_0) then
        local cmd_fragment = _830_0
  ...
  local function reload(module_name, env, on_values, on_error)
    local _834_0, _835_0 = pcall(specials["load-code"]("return require(...)", env), module_name)
    if ((_834_0 == true) and (nil ~= _835_0)) then
      ...
      local new = nil
      do
        local _836_0, _837_0 = pcall(require, module_name)
        if ((_836_0 == true) and (nil ~= _837_0)) then
          local new0 = _837_0
          new = new0
        elseif (true and (nil ~= _837_0)) then
          local _1 = _836_0
          local msg = _837_0
          on_error("Repl", msg)
    ...
    elseif ((_834_0 == false) and (nil ~= _835_0)) then
      ...
      elseif specials["macro-loaded"][module_name] then
        ...
        local function _842_()
          local _841_0 = msg:gsub("\n.*", "")
          return _841_0
        end
        return on_error("Runtime", _842_())
      end
    end
  end
  local function run_command(read, on_error, f)
    local _845_0, _846_0, _847_0 = pcall(read)
    if ((_845_0 == true) and (_846_0 == true) and (nil ~= _847_0)) then
      local val = _847_0
      local _848_0, _849_0 = pcall(f, val)
      if ((_848_0 == false) and (nil ~= _849_0)) then
        local msg = _849_0
        return on_error("Runtime", msg)
      end
    elseif (_845_0 == false) then
  ...
  commands.complete = function(env, read, on_values, on_error, scope, chars)
    ...
    return run_command(read, on_error, _853_)
  end
  ...
  local function apropos_2a(pattern, tbl, prefix, seen, names)
    for name, subtbl in pairs(tbl) do
      if (("string" == type(name)) and (package ~= subtbl)) then
        local _854_0 = type(subtbl)
        if (_854_0 == "function") then
          if ((prefix .. name)):match(pattern) then
            table.insert(names, (prefix .. name))
          end
        elseif (_854_0 == "table") then
          if not seen[subtbl] then
            ...
            apropos_2a(pattern, subtbl, (prefix .. name:gsub("%.", "/") .. "."), _856_, names)
          end
        end
      end
    end
  ...
  commands.apropos = function(_env, read, on_values, on_error, _scope)
    local function _860_(_241)
      return on_values(apropos(tostring(_241)))
    end
    return run_command(read, on_error, _860_)
  end
    ...
    for _, path in ipairs(apropos(".*")) do
      ...
      do
        ...
        if ("function" == type(tgt)) then
          local _864_0 = (compiler.metadata):get(tgt, "fnl/docstring")
          if (nil ~= _864_0) then
            local docstr = _864_0
  ...
  commands["apropos-doc"] = function(_env, read, on_values, on_error, _scope)
    ...
    return run_command(read, on_error, _868_)
  end
  ...
  commands["apropos-show-docs"] = function(_env, read, on_values, on_error)
    ...
    return run_command(read, on_error, _870_)
  end
  ...
  local function resolve(identifier, _871_0, scope)
    local _872_ = _871_0
    local env = _872_
    local ___replLocals___ = _872_["___replLocals___"]
    local e = nil
    local function _873_(_241, _242)
      return (___replLocals___[scope.unmanglings[_242]] or env[_242])
    end
    e = setmetatable({}, {__index = _873_})
    local function _874_(...)
      local _875_0, _876_0 = ...
      if ((_875_0 == true) and (nil ~= _876_0)) then
        local code = _876_0
        local function _877_(...)
          local _878_0, _879_0 = ...
          if ((_878_0 == true) and (nil ~= _879_0)) then
            local val = _879_0
            return val
          else
            local _ = _878_0
        ...
        return _877_(pcall(specials["load-code"](code, e)))
      else
        local _ = _875_0
        return nil
      end
    end
    return _874_(pcall(compiler["compile-string"], tostring(identifier), {scope = scope}))
  end
  commands.find = function(env, read, on_values, on_error, scope)
    local function _882_(_241)
      local _883_0 = nil
      do
        local _884_0 = utils["sym?"](_241)
        if (nil ~= _884_0) then
          local _885_0 = resolve(_884_0, env, scope)
          if (nil ~= _885_0) then
            _883_0 = debug.getinfo(_885_0)
          else
            _883_0 = _885_0
          end
        else
      ...
      local function _888_()
        local line = _883_0.linedefined
        local source = _883_0.source
        return (("string" == type(source)) and ("@" == source:sub(1, 1)))
      end
      if (((_G.type(_883_0) == "table") and (nil ~= _883_0.linedefined) and (nil ~= _883_0.source) and (_883_0.what == "Lua")) and _888_()) then
        local line = _883_0.linedefined
        local source = _883_0.source
        local fnlsrc = nil
        do
          local _889_0 = compiler.sourcemap
          if (nil ~= _889_0) then
            _889_0 = _889_0[source]
          end
          if (nil ~= _889_0) then
            _889_0 = _889_0[line]
          end
    ...
    return run_command(read, on_error, _882_)
  end
  ...
  commands.doc = function(env, read, on_values, on_error, scope)
    ...
    return run_command(read, on_error, _894_)
  end
  ...
  commands.compile = function(_, read, on_values, on_error, _0, _1, opts)
    local function _897_(_241)
      local _898_0, _899_0 = pcall(compiler.compile, _241, opts)
      if ((_898_0 == true) and (nil ~= _899_0)) then
        local result = _899_0
        return on_values({result})
      elseif (true and (nil ~= _899_0)) then
        local _2 = _898_0
        local msg = _899_0
        return on_error("Repl", ("Error compiling expression: " .. msg))
      end
    end
    return run_command(read, on_error, _897_)
  end
  ...
  local function load_plugin_commands(plugins)
    for i = #(plugins or {}), 1, -1 do
      for name, f in pairs(plugins[i]) do
        local _901_0 = name:match("^repl%-command%-(.*)")
        if (nil ~= _901_0) then
          local cmd_name = _901_0
          commands[cmd_name] = f
        end
      end
    end
  ...
  local function run_command_loop(input, read, loop, env, on_values, on_error, scope, chars, opts)
    ...
    do
      local _903_0 = commands[command_name]
      if (nil ~= _903_0) then
        local command = _903_0
  ...
  local function try_readline_21(opts, ok, readline)
    if ok then
      ...
      opts.readChunk = function(parser_state)
        local _908_0 = readline.readline(prompt_for((0 == parser_state["stack-size"])))
        if (nil ~= _908_0) then
          local input = _908_0
          return (input .. "\n")
        end
  ...
  local function repl(_3foptions)
    ...
    local _912_ = copy(_3foptions)
    local opts = _912_
    local _3ffennelrc = _912_["fennelrc"]
    local _ = nil
    opts.fennelrc = nil
    _ = nil
    ...
    local function _914_(_241)
      return callbacks.readChunk(_241)
    end
    byte_stream, clear_stream = parser.granulate(_914_)
    local chars = {}
    local read, reset = nil, nil
    local function _915_(parser_state)
    ...
    read, reset = parser.parser(_915_)
    depth = (depth + 1)
    ...
    if opts.registerCompleter then
      local function _921_()
        local _920_0 = opts.scope
        local function _922_(...)
          return completer(env, _920_0, ...)
        end
        return _922_
      end
      opts.registerCompleter(_921_())
    end
      ...
      elseif command_3f(src_string) then
        ...
        if not_eof_3f then
          local function _926_(...)
            local _927_0, _928_0 = ...
            if ((_927_0 == true) and (nil ~= _928_0)) then
              local src = _928_0
              local function _929_(...)
                local _930_0, _931_0 = ...
                if ((_930_0 == true) and (nil ~= _931_0)) then
                  local chunk = _931_0
                  ...
                  return xpcall(_932_, _933_)
                elseif ((_930_0 == false) and (nil ~= _931_0)) then
                  local msg = _931_0
                  clear_stream()
              ...
              return _929_(_936_(...))
            elseif ((_927_0 == false) and (nil ~= _928_0)) then
              local msg = _928_0
              clear_stream()
              return callbacks.onError("Compile", msg)
            end
          ...
          _926_(pcall(compiler.compile, form, _938_()))
  ...
  repl_mt.__call = function(_944_0, _3fopts)
    local _945_ = _944_0
    local overrides = _945_
    local view_opts = _945_["view-opts"]
    local opts = copy(_3fopts, copy(overrides))
    local _947_
    do
      local _946_0 = _3fopts
      if (nil ~= _946_0) then
        _946_0 = _946_0["view-opts"]
      end
      _947_ = _946_0
    end
    opts["view-opts"] = copy(_947_, copy(view_opts))
    return repl(opts)
  end
  return setmetatable({["view-opts"] = {}}, repl_mt)
end
package.preload["fennel.specials"] = package.preload["fennel.specials"] or function(...)
  local _534_ = require("fennel.utils")
  local utils = _534_
  local pack = _534_["pack"]
  local unpack = _534_["unpack"]
  local view = require("fennel.view")
  local parser = require("fennel.parser")
  local compiler = require("fennel.compiler")
  ...
  local function wrap_env(env)
    ...
    local function _537_(_, key, value)
      if utils["string?"](key) then
    ...
    local function _539_()
      ...
      do
        ...
        for k, v in utils.stablepairs(env) do
          ...
          if utils["string?"](k) then
            _541_ = compiler["global-unmangling"](k)
          else
            _541_ = k
          end
          k_15_, v_16_ = _541_, v
      ...
      return next, _540_, nil
    end
    return setmetatable({}, {__index = _535_, __newindex = _537_, __pairs = _539_})
  end
  ...
  local function current_global_names(_3fenv)
    local mt = nil
    do
      local _544_0 = getmetatable(_3fenv)
      if ((_G.type(_544_0) == "table") and (nil ~= _544_0.__pairs)) then
        local mtpairs = _544_0.__pairs
        local tbl_14_ = {}
  ...
  local function load_code(code, _3fenv, _3ffilename)
    ...
    local _549_0, _550_0 = rawget(_G, "setfenv"), rawget(_G, "loadstring")
    if ((nil ~= _549_0) and (nil ~= _550_0)) then
      local setfenv = _549_0
      local loadstring = _550_0
  ...
  local function doc_2a(tgt, name)
    ...
    elseif utils["callable?"](tgt) then
  ...
  local function compile_value(v)
    ...
    local chunk = {}
    local _563_ = compiler.compile1(v, scope, chunk, opts)
    local _564_ = _563_[1]
    local v0 = _564_[1]
    return v0
  end
  ...
  local function get_fn_name(ast, scope, fn_name, _3fmulti)
    if (fn_name and (fn_name[1] ~= "nil")) then
      ...
      if not _3fmulti then
        _570_ = compiler["declare-local"](fn_name, scope, ast)
      else
        _570_ = compiler["symbol-to-expression"](fn_name, scope)[1]
      end
      return _570_, not _3fmulti, 3
    else
      return nil, true, 2
    end
  end
  local function build_typed_params(arg_name_list, arg_types)
    local parts = {}
    for i, name in ipairs(arg_name_list) do
      local type_ann = arg_types[name]
      if type_ann then
        table.insert(parts, (name .. ": " .. type_ann))
      else
  ...
  local function compile_named_fn(ast, f_scope, f_chunk, parent, index, fn_name, local_3f, arg_name_list, f_metadata, _3farg_types, _3freturn_type, _3fgeneric_params)
    ...
    do
      ...
      local function _575_()
        local _574_0 = utils.root.options
        if (nil ~= _574_0) then
          _574_0 = _574_0.target
        end
        return _574_0
      end
      target = (_575_() or "lua")
      local emit_types = (target == "luau")
      local param_str = nil
      if (emit_types and _3farg_types) then
        param_str = build_typed_params(arg_name_list, _3farg_types)
      else
        param_str = table.concat(arg_name_list, ", ")
      end
      local ret_str = nil
      if (emit_types and _3freturn_type) then
        ret_str = (": " .. _3freturn_type)
      else
        ret_str = ""
      end
      local generic_str = nil
      if (emit_types and _3fgeneric_params and (#_3fgeneric_params > 0)) then
        generic_str = ("<" .. table.concat(_3fgeneric_params, ", ") .. ">")
      else
        generic_str = ""
      end
      local _580_
      if local_3f then
        _580_ = "local function %s%s(%s)%s"
      else
        _580_ = "%s = function%s(%s)%s"
      end
      compiler.emit(parent, string.format(_580_, fn_name, generic_str, param_str, ret_str), ast)
    end
  ...
  local function compile_anonymous_fn(ast, f_scope, f_chunk, parent, index, arg_name_list, f_metadata, scope, _3farg_types, _3freturn_type, _3fgeneric_params)
    local fn_name = compiler.gensym(scope)
    return compile_named_fn(ast, f_scope, f_chunk, parent, index, fn_name, true, arg_name_list, f_metadata, _3farg_types, _3freturn_type, _3fgeneric_params)
  end
  ...
  local function get_function_metadata(ast, arg_list, index)
    ...
    local function _585_(_241, _242)
      _241["fnl/docstring"] = _242
      return _241
    end
    return maybe_metadata(ast, utils["kv-table?"], _583_, maybe_metadata(ast, utils["string?"], _585_, {["fnl/arglist"] = arg_list}, index))
  end
  local function compile_type_expr(expr)
    if (expr == nil) then
      return "any"
    elseif utils["string?"](expr) then
      return expr
    elseif utils["sym?"](expr) then
      return tostring(expr)
    elseif utils["list?"](expr) then
      local head = tostring(expr[1])
      if (head == "?") then
        return (compile_type_expr(expr[2]) .. "?")
      elseif (head == "|") then
        local parts = nil
        do
          local tbl_17_ = {}
        ...
        return table.concat(parts, " | ")
      elseif (head == "array") then
        return ("{" .. compile_type_expr(expr[2]) .. "}")
      elseif (head == "->") then
        local params = expr[2]
        local ret = expr[3]
        local param_strs = nil
        do
          local tbl_17_ = {}
          local i_18_ = #tbl_17_
          for _, p in ipairs(params) do
            local val_19_ = compile_type_expr(p)
            if (nil ~= val_19_) then
              i_18_ = (i_18_ + 1)
              tbl_17_[i_18_] = val_19_
            end
        ...
        return ("(" .. table.concat(param_strs, ", ") .. ") -> " .. compile_type_expr(ret))
      else
        local type_args = nil
        do
          local tbl_17_ = {}
        ...
        return (head .. "<" .. table.concat(type_args, ", ") .. ">")
      end
    elseif utils["table?"](expr) then
      local fields = nil
      do
        local tbl_17_ = {}
        local i_18_ = #tbl_17_
        for k, v in utils.stablepairs(expr) do
          local val_19_ = (tostring(k) .. ": " .. compile_type_expr(v))
          if (nil ~= val_19_) then
            i_18_ = (i_18_ + 1)
            tbl_17_[i_18_] = val_19_
          end
  ...
  SPECIALS.deftype = function(ast, scope, parent)
    do
      local target = nil
      local function _595_()
        local _594_0 = utils.root.options
        if (nil ~= _594_0) then
          _594_0 = _594_0.target
        end
        return _594_0
      end
      target = (_595_() or "lua")
      compiler.assert((target == "luau"), "type aliases (deftype) only available with --target luau", ast)
      compiler.assert((#ast >= 3), "expected type name and definition", ast)
      local type_name = tostring(ast[2])
      local type_def = ast[3]
      local type_str = compile_type_expr(type_def)
      compiler.emit(parent, ("type " .. type_name .. " = " .. type_str), ast)
    end
    return nil
  end
  doc_special("deftype", {"name", "definition"}, "Define a Luau type alias. Only with --target luau.\nExamples: (deftype UserId number), (deftype Point {x :number y :number})")
  local function luau_type_annotation_3f(x)
    return utils["string?"](x)
  end
  local function parse_typed_arg_list(arg_list)
    local filtered = {}
    local arg_types = {}
    local i = 1
    while (i <= #arg_list) do
      local current = arg_list[i]
      local next_item = arg_list[(i + 1)]
      if luau_type_annotation_3f(current) then
        i = (i + 1)
      else
        table.insert(filtered, current)
        if (next_item and luau_type_annotation_3f(next_item)) then
          do
            local arg_name = tostring(current)
            arg_types[arg_name] = next_item
          end
          i = (i + 1)
        end
        i = (i + 1)
    ...
    return filtered, arg_types
  end
  local function parse_return_type(ast, index)
    local arrow_pos = (index + 1)
    local arrow = ast[arrow_pos]
    local arrow_str = (arrow and tostring(arrow))
    if ((arrow_str == ":->") or (arrow_str == "->")) then
      local ret_type = ast[(arrow_pos + 1)]
      return tostring(ret_type), (arrow_pos + 2)
    else
      return nil, (index + 1)
    end
  end
  local function generic_type_params_3f(tbl, next_tbl)
    local function _600_()
      local all_syms = true
      for _, v in ipairs(tbl) do
        if not all_syms then break end
        all_syms = utils["sym?"](v)
      end
      return all_syms
    end
    return (utils["table?"](tbl) and utils["table?"](next_tbl) and (#tbl > 0) and _600_())
  end
  local function parse_generic_params(tbl)
    local tbl_17_ = {}
    local i_18_ = #tbl_17_
    for _, v in ipairs(tbl) do
  ...
  SPECIALS.fn = function(ast, scope, parent)
    local f_scope = nil
    do
      local _602_0 = compiler["make-scope"](scope)
      _602_0["vararg"] = false
      f_scope = _602_0
    end
    local f_chunk = {}
    ...
    local function _604_()
      local _603_0 = utils.root.options
      if (nil ~= _603_0) then
        _603_0 = _603_0.target
      end
      return _603_0
    end
    target = (_604_() or "lua")
    local first_tbl = ast[index]
    local next_tbl = ast[(index + 1)]
    local has_generics = ((target == "luau") and generic_type_params_3f(first_tbl, next_tbl))
    local generic_params = nil
    if has_generics then
      generic_params = parse_generic_params(first_tbl)
    else
      generic_params = {}
    end
    local arg_list_index = nil
    if has_generics then
      arg_list_index = (index + 1)
    else
      arg_list_index = index
    end
    local raw_arg_list = compiler.assert(utils["table?"](ast[arg_list_index]), "expected parameters table", ast)
    local arg_list, arg_types = nil, nil
    if (target == "luau") then
      arg_list, arg_types = parse_typed_arg_list(raw_arg_list)
    else
      arg_list, arg_types = raw_arg_list, {}
    end
    ...
    local return_type, body_start = nil, nil
    if (target == "luau") then
      return_type, body_start = parse_return_type(ast, arg_list_index)
    else
      return_type, body_start = nil, (arg_list_index + 1)
    end
    local f_metadata, final_index = get_function_metadata(ast, arg_list, (body_start - 1))
    local compile_index = nil
    if return_type then
      compile_index = (body_start - 1)
    else
      compile_index = final_index
    end
    if fn_name then
      return compile_named_fn(ast, f_scope, f_chunk, parent, compile_index, fn_name, local_3f, arg_name_list, f_metadata, arg_types, return_type, generic_params)
    else
      return compile_anonymous_fn(ast, f_scope, f_chunk, parent, compile_index, arg_name_list, f_metadata, scope, arg_types, return_type, generic_params)
    end
  end
  ...
  SPECIALS.lua = function(ast, _, parent)
    ...
    local _616_
    do
      local _615_0 = utils["sym?"](ast[2])
      if (nil ~= _615_0) then
        _616_ = tostring(_615_0)
      else
        _616_ = _615_0
      end
    end
    ...
    local _620_
    do
      local _619_0 = utils["sym?"](ast[3])
      if (nil ~= _619_0) then
        _620_ = tostring(_619_0)
      else
        _620_ = _619_0
      end
    end
  ...
  local function dot(ast, scope, parent)
    ...
    local _623_ = compiler.compile1(lhs_node, scope, parent, {nval = 1})
    local lhs = _623_[1]
    if (len == 2) then
      return tostring(lhs)
    else
      ...
      for i = 3, len do
        ...
        if (utils["string?"](index) and utils["valid-lua-identifier?"](index)) then
          ...
          local _624_ = compiler.compile1(index, scope, parent, {nval = 1})
          local index0 = _624_[1]
  ...
  doc_special("set", {"name", "val"}, "Set a local variable or table field to a new value.\nOnly works on table fields or locals declared with var.")
  ...
  local function typed_local_3f(ast)
    return ((#ast == 4) and utils["sym?"](ast[2]) and utils["string?"](ast[3]))
  end
  local function compile_typed_local(ast, scope, parent)
    local name_sym = ast[2]
    local type_str = ast[3]
    local value = ast[4]
    local lname = compiler["declare-local"](name_sym, scope, ast)
    local _628_ = compiler.compile1(value, scope, parent, {nval = 1})
    local value_result = _628_[1]
    return compiler.emit(parent, string.format("local %s: %s = %s", lname, type_str, tostring(value_result)), ast)
  end
  local function local_2a(ast, scope, parent, opts)
    ...
    do
      ...
      local function _630_()
        local _629_0 = utils.root.options
        if (nil ~= _629_0) then
          _629_0 = _629_0.target
        end
        return _629_0
      end
      target = (_630_() or "lua")
      if ((target == "luau") and typed_local_3f(ast)) then
        compile_typed_local(ast, scope, parent)
      else
        compiler.assert((#ast == 3), "expected name and value", ast)
  ...
  SPECIALS.var = function(ast, scope, parent, opts)
    ...
    do
      ...
      local function _634_()
        local _633_0 = utils.root.options
        if (nil ~= _633_0) then
          _633_0 = _633_0.target
        end
        return _633_0
      end
      target = (_634_() or "lua")
      if ((target == "luau") and typed_local_3f(ast)) then
        ...
        local type_str = ast[3]
        local value = ast[4]
        local lname = compiler["declare-local"](name_sym, scope, ast, {isvar = true})
        compiler.emit(parent, string.format("local %s: %s = %s", lname, type_str, tostring(compiler.compile1(value, scope, parent, {nval = 1})[1])), ast)
      else
        compiler.assert((#ast == 3), "expected name and value", ast)
  ...
  doc_special("var", {"name", "val"}, "Introduce new mutable local.\nWith --target luau, supports typed syntax: (var name :type value)")
  ...
  SPECIALS.let = function(_640_0, scope, parent, opts)
    local _641_ = _640_0
    local _ = _641_[1]
    local bindings = _641_[2]
    local ast = _641_
  ...
  doc_special("tset", {"tbl", "key1", "...", "keyN", "val"}, "Set the value of a table field. Usually better to use set.")
  ...
  local function if_2a(ast, scope, parent, opts)
    ...
    if (#ast == 2) then
      ...
      for i = 2, (#ast - 1), 2 do
        local condchunk = {}
        local _650_ = compiler.compile1(ast[i], do_scope, condchunk, {nval = 1})
        local cond = _650_[1]
  ...
  local function remove_until_condition(bindings, ast)
    ...
    for i = (#bindings - 1), 3, -1 do
      local _656_0 = clause_3f(bindings[i])
      if ((_656_0 == false) or (_656_0 == nil)) then
      elseif (nil ~= _656_0) then
        local clause = _656_0
  ...
  local function compile_until(_3fcondition, scope, chunk)
    if _3fcondition then
      local _658_ = compiler.compile1(_3fcondition, scope, chunk, {nval = 1})
      local condition_lua = _658_[1]
  ...
  local function method_call(ast, scope, parent)
    ...
    for i = 4, #ast do
      ...
      subexprs = compiler.compile1(ast[i], scope, parent, {nval = _670_})
      local tbl_17_ = args
      local i_18_ = #tbl_17_
    ...
    local _673_0 = method_special_type(ast)
    if (_673_0 == "native") then
      return native_method_call(ast, scope, parent, target, args)
    elseif (_673_0 == "nonnative") then
      return nonnative_method_call(ast, scope, parent, target, args)
    elseif (_673_0 == "binding") then
  ...
  SPECIALS.hashfn = function(ast, scope, parent)
    ...
    local f_scope = nil
    do
      local _680_0 = compiler["make-scope"](scope)
      _680_0["vararg"] = false
      _680_0["hashfn"] = true
      f_scope = _680_0
    end
  ...
  local function short_circuit_safe_3f(x, scope)
    ...
    elseif utils["list?"](x) then
      if utils["sym?"](x[1]) then
        local _686_0 = str1(x)
        if ((_686_0 == "fn") or (_686_0 == "hashfn") or (_686_0 == "let") or (_686_0 == "local") or (_686_0 == "var") or (_686_0 == "set") or (_686_0 == "tset") or (_686_0 == "if") or (_686_0 == "each") or (_686_0 == "for") or (_686_0 == "while") or (_686_0 == "do") or (_686_0 == "lua") or (_686_0 == "global")) then
          return false
        elseif (((_686_0 == "<") or (_686_0 == ">") or (_686_0 == "<=") or (_686_0 == ">=") or (_686_0 == "=") or (_686_0 == "not=") or (_686_0 == "~=")) and (comparator_special_type(x) == "binding")) then
          return false
        else
          local function _687_()
            return (1 ~= x[2])
          end
          if ((_686_0 == "pick-values") and _687_()) then
            return false
          else
  ...
  local function emit_short_circuit_if(ast, scope, parent, name, subast, accumulator, expr_string, setter)
    ...
    compiler.emit(parent, ("if %s then"):format(_698_()), subast)
    do
      local chunk = {}
  ...
  local function define_arithmetic_special(name, _3fzero_arity, _3funary_prefix, _3flua_name)
    local _704_
    do
      local _703_0 = (_3flua_name or name)
      local function _705_(...)
        return operator_special(_703_0, _3fzero_arity, _3funary_prefix, ...)
      end
      _704_ = _705_
    end
    SPECIALS[name] = _704_
  ...
  local function bitop_special(native_name, lib_name, zero_arity, unary_prefix, ast, scope, parent)
    if (#ast == 1) then
      ...
      for i = 2, len do
        ...
        subexprs = compiler.compile1(ast[i], scope, parent, {nval = _706_})
  ...
  SPECIALS.bnot = function(ast, scope, parent)
    compiler.assert((#ast == 2), "expected one argument", ast)
    local _714_ = compiler.compile1(ast[2], scope, parent, {nval = 1})
    local value = _714_[1]
    if utils.root.options.useBitLib then
  ...
  local function native_comparator(op, _716_0, scope, parent)
    local _717_ = _716_0
    local _ = _717_[1]
    local lhs_ast = _717_[2]
    local rhs_ast = _717_[3]
    local _718_ = compiler.compile1(lhs_ast, scope, parent, {nval = 1})
    local lhs = _718_[1]
    local _719_ = compiler.compile1(rhs_ast, scope, parent, {nval = 1})
    local rhs = _719_[1]
  ...
  local function binding_comparator(op, chain_op, ast, scope, parent)
    ...
    return ("(" .. table.concat(_723_, chain) .. ")")
  end
  local function define_comparator_special(name, _3flua_op, _3fchain_op)
    do
      ...
      local function opfn(ast, scope, parent)
        ...
        local _725_0 = comparator_special_type(ast)
        if (_725_0 == "native") then
          return native_comparator(op, ast, scope, parent)
        elseif (_725_0 == "idempotent") then
          return idempotent_comparator(op, _3fchain_op, ast, scope, parent)
        elseif (_725_0 == "binding") then
  ...
  SPECIALS.as = function(ast, scope, parent)
    local target = nil
    local function _728_()
      local _727_0 = utils.root.options
      if (nil ~= _727_0) then
        _727_0 = _727_0.target
      end
      return _727_0
    end
    target = (_728_() or "lua")
    compiler.assert((target == "luau"), "type casts (as) only available with --target luau", ast)
    compiler.assert((#ast == 3), "expected type and expression", ast)
    local type_str = tostring(ast[2])
    local _730_ = compiler.compile1(ast[3], scope, parent, {nval = 1})
    local expr_result = _730_[1]
    return utils.expr(string.format("(%s) :: %s", tostring(expr_result), type_str), "expression")
  end
  doc_special("as", {"type", "expr"}, "Luau type cast: (as number x) -> (x) :: number. Only with --target luau.")
  ...
  local function make_compiler_env(_3fast, _3fscope, _3fparent, _3fopts)
    local provided = nil
    do
      local _736_0 = (_3fopts or utils.root.options)
      if ((_G.type(_736_0) == "table") and (_736_0["compiler-env"] == "strict")) then
        provided = safe_compiler_env()
      elseif ((_G.type(_736_0) == "table") and (nil ~= _736_0.compilerEnv)) then
        local compilerEnv = _736_0.compilerEnv
        provided = compilerEnv
      elseif ((_G.type(_736_0) == "table") and (nil ~= _736_0["compiler-env"])) then
        local compiler_env = _736_0["compiler-env"]
        provided = compiler_env
      elseif ((_G.type(_736_0) == "table") and (nil ~= _736_0["extra-compiler-env"])) then
        local extra_compiler_env = _736_0["extra-compiler-env"]
  ...
  local _745_ = _743_(...)
  local dirsep = _745_[1]
  local pathsep = _745_[2]
  local pathmark = _745_[3]
  ...
  local function search_module(modulename, _3fpathstring)
    ...
    local function find_in_path(start, _3ftried_paths)
      local _748_0 = fullpath:match(pattern, start)
      if (nil ~= _748_0) then
        local path = _748_0
        local _749_0, _750_0 = try_path(path)
        if (nil ~= _749_0) then
          local filename = _749_0
          return filename
        elseif ((_749_0 == nil) and (nil ~= _750_0)) then
          local error = _750_0
          local function _752_()
            local _751_0 = (_3ftried_paths or {})
            table.insert(_751_0, error)
            return _751_0
          end
          return find_in_path((start + #path + 1), _752_())
        end
      else
        local _ = _748_0
  ...
  local function make_searcher(_3foptions)
    local function _757_(module_name)
      local opts = utils.copy(utils.root.options)
      for k, v in pairs((_3foptions or {})) do
        opts[k] = v
      end
      opts["module-name"] = module_name
      local _758_0, _759_0 = search_module(module_name, (_3foptions and _3foptions.path))
      if (nil ~= _758_0) then
        local filename = _758_0
        local function _760_(...)
          return utils["fennel-module"].dofile(filename, opts, ...)
        end
        return _760_, filename
      elseif ((_758_0 == nil) and (nil ~= _759_0)) then
        local error = _759_0
        return error
      end
    end
  ...
  local function fennel_macro_searcher(module_name)
    local opts = nil
    do
      local _762_0 = utils.copy(utils.root.options)
      _762_0["module-name"] = module_name
      _762_0["env"] = "_COMPILER"
      _762_0["requireAsInclude"] = false
      _762_0["allowedGlobals"] = nil
      opts = _762_0
    end
    local _763_0 = search_module(module_name, utils["fennel-module"]["macro-path"])
    if (nil ~= _763_0) then
      local filename = _763_0
      local _764_
      ...
      return _764_, filename
    end
  end
  local function lua_macro_searcher(module_name)
    local _769_0 = search_module(module_name, package.path)
    if (nil ~= _769_0) then
      local filename = _769_0
      local code = nil
      do
        ...
        code = close_handlers_10_(_G.xpcall(_771_, (package.loaded.fennel or debug).traceback))
      end
  ...
  local function search_macro_module(modname, n)
    local _773_0 = macro_searchers[n]
    if (nil ~= _773_0) then
      local f = _773_0
      local _774_0, _775_0 = f(modname)
      if ((nil ~= _774_0) and true) then
        local loader = _774_0
        local _3ffilename = _775_0
  ...
  local function sandbox_fennel_module(modname)
    if ((modname == "fennel.macros") or (package and package.loaded and ("table" == type(package.loaded[modname])) and (package.loaded[modname].metadata == compiler.metadata))) then
      local function _778_(_, ...)
        return (compiler.metadata):setall(...)
      end
      return {metadata = {setall = _778_}, view = view}
    end
  end
  local function _780_(modname)
    ...
    return (macro_loaded[modname] or sandbox_fennel_module(modname) or _781_())
  end
  safe_require = _780_
  local function add_macros(macros_2a, ast, scope)
    compiler.assert(utils["table?"](macros_2a), "expected macros to be table", ast)
    for k, v in pairs(macros_2a) do
      compiler.assert(utils["callable?"](v), "expected each macro to be function or callable table", ast)
      compiler["check-binding-valid"](utils.sym(k), scope, ast, {["macro?"] = true})
      scope.macros[k] = v
    end
    return nil
  end
  local function resolve_module_name(_782_0, _scope, _parent, opts)
    local _783_ = _782_0
    local second = _783_[2]
    local filename = _783_["filename"]
  ...
  local function emit_included_fennel(src, path, opts, sub_chunk)
    local subscope = compiler["make-scope"](utils.root.scope)
    local forms = {}
  ...
  local function include_path(ast, opts, path, mod, fennel_3f)
    ...
    do
      ...
      src = close_handlers_10_(_G.xpcall(_789_, (package.loaded.fennel or debug).traceback))
    end
  ...
  SPECIALS.include = function(ast, scope, parent, opts)
    ...
    local modexpr = nil
    do
      local _792_0, _793_0 = pcall(resolve_module_name, ast, scope, parent, opts)
      if ((_792_0 == true) and (nil ~= _793_0)) then
        local modname = _793_0
    ...
    if ((modexpr.type ~= "literal") or ((modexpr[1]):byte() ~= 34)) then
      ...
      local function _797_()
        local _796_0 = search_module(mod)
        if (nil ~= _796_0) then
          local fennel_path = _796_0
      ...
      res = ((utils["member?"](mod, (utils.root.options.skipInclude or {})) and opts.fallback(modexpr, true)) or include_circular_fallback(mod, modexpr, opts.fallback, ast) or utils.root.scope.includes[mod] or _797_())
  ...
  SPECIALS["pick-values"] = function(ast, scope, parent)
    ...
    if (1 == n) then
      local _801_ = compiler.compile1(vals, scope, parent, {nval = 1})
      local _802_ = _801_[1]
      local expr = _802_[1]
      return {("(" .. expr .. ")")}
    elseif (0 == n) then
...
package.preload["fennel.compiler"] = package.preload["fennel.compiler"] or function(...)
  local _303_ = require("fennel.utils")
  local utils = _303_
  local unpack = _303_["unpack"]
  local parser = require("fennel.parser")
  ...
  local function assert_compile(condition, msg, _3fast, _3ffallback_ast)
    if not condition then
      local _307_ = (utils.root.options or {})
      local error_pinpoint = _307_["error-pinpoint"]
      local source = _307_["source"]
      local unfriendly = _307_["unfriendly"]
      local ast = nil
  ...
  do
    ...
    local function _312_(str)
      local function _313_(_241, _242)
        if (0 == (_241:len() % 2)) then
          local _314_0 = subst_digits[_242]
          if (_314_0 ~= nil) then
            return (_241 .. _314_0)
          else
            return _314_0
      ...
      return string.format("%q", str):gsub("\\\n", "\\n"):gsub("(\\*)(\\%d%d?%d?)", _313_):gsub("[\127-\255]", _317_)
    end
    serialize_string = _312_
  end
  local function global_mangling(str)
    if utils["valid-lua-identifier?"](str) then
      ...
      local _319_
      do
        local _318_0 = utils.root.options
        if (nil ~= _318_0) then
          _318_0 = _318_0["global-mangle"]
        end
        _319_ = _318_0
      end
      if (_319_ == false) then
        ...
        return ("__fnl_global__" .. str:gsub("[^%w]", _321_))
      end
    end
  end
  local function global_unmangling(identifier)
    local _323_0 = string.match(identifier, "^__fnl_global__(.*)$")
    if (nil ~= _323_0) then
      local rest = _323_0
      local _324_0 = nil
      ...
      _324_0 = rest:gsub("_[%da-f][%da-f]", _325_)
      return _324_0
    else
      local _ = _323_0
      return identifier
  ...
  local function global_allowed_3f(name)
    local allowed = nil
    do
      local _327_0 = utils.root.options
      if (nil ~= _327_0) then
        _327_0 = _327_0.allowedGlobals
      end
      allowed = _327_0
    end
  ...
  local function autogensym(base, scope)
    local _333_0 = utils["multi-sym?"](base)
    if (nil ~= _333_0) then
      local parts = _333_0
      ...
      return (scope.autogensyms[base] or _334_())
    end
  end
  local function check_binding_valid(symbol, scope, ast, _3fopts)
    ...
    local part1 = nil
    do
      local _336_0 = utils["multi-sym?"](symbol)
      if ((_G.type(_336_0) == "table") and (nil ~= _336_0[1])) then
        local p = _336_0[1]
        part1 = p
      else
      part1 = nil
  ...
  local function declare_local(symbol, scope, ast, _3fvar_3f, _3fdeferred_scope_changes)
    ...
    mangling = string.gsub(string.gsub(raw, "-", "_"), "[^%w_]", _341_)
  ...
  local function symbol_to_expression(symbol, scope, _3freference_3f)
    ...
    local function _346_()
      local _345_0 = utils.root.options
      if (nil ~= _345_0) then
        _345_0 = _345_0.allowedGlobals
      end
      return _345_0
    end
    if (_346_() and not local_3f and scope.parent) then
  ...
  local function flatten_chunk(file_sourcemap, chunk, tab, depth)
    if chunk.leaf then
      local _356_ = utils["ast-source"](chunk.ast)
      local endline = _356_["endline"]
      local filename = _356_["filename"]
      local line = _356_["line"]
      ...
      do
        ...
        if (_358_0 == true) then
          tab0 = "  "
        elseif (_358_0 == false) then
          tab0 = ""
        elseif (nil ~= _358_0) then
          local tab1 = _358_0
          tab0 = tab1
        elseif (_358_0 == nil) then
          tab0 = ""
        else
        tab0 = nil
        end
  ...
  local function make_metadata()
    local function _368_(self, tgt, _3fkey)
      if self[tgt] then
        if (nil ~= _3fkey) then
    ...
    local function _371_(self, tgt, key, value)
      self[tgt] = (self[tgt] or {})
      self[tgt][key] = value
      return tgt
    end
    local function _372_(self, tgt, ...)
      local kv_len = select("#", ...)
      local kvs = {...}
      if ((kv_len % 2) ~= 0) then
    ...
    return setmetatable({}, {__index = {get = _368_, set = _371_, setall = _372_}, __mode = "k"})
  end
  ...
  local function handle_compile_opts(exprs, parent, opts, _3fast)
    ...
    if opts.target then
      ...
      emit(parent, string.format("%s = %s", opts.target, _382_()), _3fast)
    end
  ...
  local function find_macro(ast, scope)
    local macro_2a = nil
    do
      local _385_0 = utils["sym?"](ast[1])
      if (_385_0 ~= nil) then
        local _386_0 = tostring(_385_0)
        if (_386_0 ~= nil) then
          macro_2a = scope.macros[_386_0]
        else
          macro_2a = _386_0
        end
      else
    ...
    if (not macro_2a and multi_sym_parts) then
      ...
      assert_compile((not scope.macros[multi_sym_parts[1]] or utils["callable?"](nested_macro)), "macro not found, or not callable, in macro table", ast[1])
      return nested_macro
    else
      return macro_2a
    end
  end
  local function propagate_trace_info(_390_0, _index, node)
    local _391_ = _390_0
    local byteend = _391_["byteend"]
    local bytestart = _391_["bytestart"]
    local col = _391_["col"]
    local filename = _391_["filename"]
    local line = _391_["line"]
  ...
  local function macroexpand_2a(ast, scope, _3fonce)
    ...
    if utils["list?"](ast) then
      _402_0 = find_macro(ast, scope)
    else
    _402_0 = nil
    end
    if (_402_0 == false) then
      return ast
    elseif (nil ~= _402_0) then
      local macro_2a = _402_0
  ...
  local function callable_3f(_412_0, ctype, callee)
    local _413_ = _412_0
    local call_ast = _413_[1]
  ...
  local function compile_function_call(ast, scope, parent, opts, compile1, len)
    local _415_ = compile1(ast[1], scope, parent, {nval = 1})[1]
    local callee = _415_[1]
    local ctype = _415_["type"]
    local fargs = {}
    ...
    for i = 2, len do
      ...
      subexprs = compile1(ast[i], scope, parent, {nval = _416_})
  ...
  local function compile_call(ast, scope, parent, opts, compile1)
    ...
    if multi_sym_parts then
      special = utils["get-in"](scope.specials, multi_sym_parts)
    elseif utils["sym?"](first) then
      special = scope.specials[tostring(first)]
    else
    special = nil
    end
  ...
  local function compile_varg(ast, scope, parent, opts)
    ...
    if scope.hashfn then
      ...
      _422_ = "unexpected vararg"
    end
    assert_compile(scope.vararg, _422_, ast)
  ...
  do
    ...
    view_opts = {["negative-infinity"] = "(-1/0)", ["negative-nan"] = _425_, infinity = "(1/0)", nan = _427_}
  end
  local function serialize_scalar(ast)
    local _429_0 = type(ast)
    if (_429_0 == "nil") then
      return "nil"
    elseif (_429_0 == "boolean") then
      return tostring(ast)
    elseif (_429_0 == "string") then
      return serialize_string(ast)
    elseif (_429_0 == "number") then
  ...
  local function compile_table(ast, scope, parent, opts, compile1)
    local function escape_key(k)
      if ((type(k) == "string") and utils["valid-lua-identifier?"](k)) then
        ...
        local _431_ = compile1(k, scope, parent, {nval = 1})
        local compiled = _431_[1]
    ...
    do
      ...
      for k in utils.stablepairs(ast) do
        local val_19_ = nil
        if not keys[k] then
          local _434_ = compile1(ast[k], scope, parent, {nval = 1})
          local v = _434_[1]
  ...
  local function destructure(to, from, ast, scope, parent, opts)
    local opts0 = (opts or {})
    local _438_ = opts0
    local declaration = _438_["declaration"]
    local forceglobal = _438_["forceglobal"]
    local forceset = _438_["forceset"]
    local isvar = _438_["isvar"]
    local symtype = _438_["symtype"]
    ...
    local function getname(symbol, ast0)
      ...
      if declaration then
        ...
        if forceglobal then
          ...
          local _443_
          do
            local _442_0 = utils.root.options
            if (nil ~= _442_0) then
              _442_0 = _442_0.allowedGlobals
            end
            _443_ = _442_0
          end
          if _443_ then
            local _446_
            do
              local _445_0 = utils.root.options
              if (nil ~= _445_0) then
                _445_0 = _445_0.allowedGlobals
              end
              _446_ = _445_0
            end
            table.insert(_446_, raw)
          end
        end
    ...
    local function dynamic_set_target(_455_0)
      local _456_ = _455_0
      local _ = _456_[1]
      local target = _456_[2]
      local keys = {(table.unpack or unpack)(_456_, 3)}
    ...
    local function destructure_kv_rest(s, v, left, excluded_keys, destructure1)
      ...
      exclude_str = table.concat(_461_, ", ")
    ...
    local function destructure_rest(s, k, left, destructure1)
      ...
      assert_compile((utils["sequence?"](left) and _463_()), "expected rest argument before last parameter", left)
    ...
    local function optimize_table_destructure_3f(left, right)
      ...
      return (utils["sequence?"](left) and utils["sequence?"](right) and _464_())
    end
    local function destructure_table(left, rightexprs, top_3f, destructure1, up1)
      ...
      if optimize_table_destructure_3f(left, rightexprs) then
        ...
        do
          local _465_0 = nil
          if top_3f then
            _465_0 = exprs1(compile1(from, scope, parent))
          else
            _465_0 = exprs1(rightexprs)
          end
          if (_465_0 == "") then
            right = "nil"
          elseif (nil ~= _465_0) then
            local right0 = _465_0
            right = right0
          else
          right = nil
  ...
  local function with_open_2a(_477_0, scope, parent, opts)
    local _478_ = _477_0
    local _ = _478_[1]
    local bindings = _478_[2]
    local ast = _478_
  ...
  local function compile_asts(asts, options)
    ...
    local _484_ = utils.root
    _484_["set-reset"](_484_)
  ...
  local function compile(from, _3fopts)
    local _487_0 = type(from)
    if (_487_0 == "userdata") then
      local function _488_()
        local _489_0 = from:read(1)
        if (nil ~= _489_0) then
          return _489_0:byte()
        else
          return _489_0
      ...
      return compile_stream(_488_, _3fopts)
    elseif (_487_0 == "function") then
  ...
  local function traceback_frame(info)
    ...
    elseif (info.what == "C") then
      ...
      if (info.what == "Lua") then
        ...
        return string.format("\9%s:%d: in function %s", info.short_src, info.currentline, _494_())
  ...
  local function trace_adjust_msg(msg)
    local function _497_(...)
      local _498_0, _499_0, _500_0 = ...
      if ((nil ~= _498_0) and (nil ~= _499_0) and (nil ~= _500_0)) then
        local file = _498_0
        local line = _499_0
        local rest = _500_0
        local function _501_(...)
          local _502_0 = ...
          if ((_G.type(_502_0) == "table") and true and (nil ~= _502_0[2])) then
            local _ = _502_0[1]
            local newline = _502_0[2]
        ...
        local function _505_(...)
          local _504_0 = sourcemap
          if (nil ~= _504_0) then
            _504_0 = _504_0[("@" .. file)]
          end
          if (nil ~= _504_0) then
            _504_0 = _504_0[tonumber(line)]
          end
          return _504_0
        end
        return _501_(_505_(...))
    ...
    if ((_509_0 == "nil") or (_509_0 == "string")) then
      ...
      if ((msg:find("^%g+:%d+:%d+: Compile error:.*") or msg:find("^%g+:%d+:%d+: Parse error:.*")) and not utils["debug-on?"]("trace")) then
        ...
        for level = (_3fstart or 2), 999 do
          ...
          local _510_0 = (lua_getinfo and lua_getinfo(level, "Sln"))
          if (_510_0 == nil) then
            lines["done?"] = true
          elseif (nil ~= _510_0) then
            local info = _510_0
  ...
  local function do_quote(form, scope, parent, runtime_3f)
    ...
    elseif (type(form) == "table") then
      ...
      return string.format("setmetatable({%s}, {filename=%s, line=%s})", mixed_concat(quote_all(form), ", "), filename, _532_())
...
package.preload["fennel.friend"] = package.preload["fennel.friend"] or function(...)
  local _198_ = require("fennel.utils")
  local utils = _198_
  local unpack = _198_["unpack"]
  ...
  pal("macro not found, or not callable, in macro table", {"checking the keys of the imported macro module's returned table", "ensuring that if the invoked macro is a table, it has a __call metamethod"})
  ...
  local function read_line(filename, line, _3fsource)
    if _3fsource then
      ...
      return close_handlers_10_(_G.xpcall(_202_, (package.loaded.fennel or debug).traceback))
    end
  end
  ...
  local function highlight_line(codeline, col, _3fendcol, _205_0)
    local _206_ = _205_0
    local error_pinpoint = _206_["error-pinpoint"]
    if ((false == error_pinpoint) or (os and os.getenv and os.getenv("NO_COLOR"))) then
      ...
      local _208_ = (error_pinpoint or {"\27[7m", "\27[0m"})
      local open = _208_[1]
      local close = _208_[2]
      return (sub(codeline, 1, col) .. open .. sub(codeline, (col + 1), (endcol + 1)) .. close .. sub(codeline, (endcol + 2), eol))
    end
  end
  local function friendly_msg(msg, _210_0, _3fsource, _3fopts)
    local _211_ = _210_0
    local col = _211_["col"]
    local endcol = _211_["endcol"]
    local endline = _211_["endline"]
  ...
  local function assert_compile(condition, msg, ast, _3fsource, _3fopts)
    if not condition then
      local _215_ = utils["ast-source"](ast)
      local col = _215_["col"]
      local filename = _215_["filename"]
      local line = _215_["line"]
...
package.preload["fennel.parser"] = package.preload["fennel.parser"] or function(...)
  local _197_ = require("fennel.utils")
  local utils = _197_
  local unpack = _197_["unpack"]
  local friend = require("fennel.friend")
  local function granulate(getchunk)
    local c, index, done_3f = "", 1, false
    local function _217_(parser_state)
      if not done_3f then
        if (index <= #c) then
          ...
          local _218_0 = getchunk(parser_state)
          if (nil ~= _218_0) then
            local input = _218_0
            c, index = input, 2
            return c:byte()
  ...
  local escapes = {["'"] = "'", ["\""] = "\"", ["\\"] = "\\", ["\n"] = "\n", a = "\7", b = "\8", f = "\12", n = "\n", r = "\13", t = "\9", v = "\11"}
  local function parser_fn(getbyte, filename, _227_0)
    local _228_ = _227_0
    local options = _228_
    local comments = _228_["comments"]
    local source = _228_["source"]
    local unfriendly = _228_["unfriendly"]
    local stack = {}
    ...
    local function whitespace_3f(b)
      local function _236_()
        local _235_0 = options.whitespace
        if (nil ~= _235_0) then
          _235_0 = _235_0[b]
        end
        return _235_0
      end
      return ((b == 32) or ((9 <= b) and (b <= 13)) or _236_())
    end
    ...
    local function parse_stream()
      ...
      local function dispatch(v, _3fsource, _3fraw)
        ...
        local v0 = nil
        do
          local _240_0 = utils["hook-opts"]("parse-form", options, v, _3fsource, _3fraw, stack)
          if (nil ~= _240_0) then
            local hookv = _240_0
            v0 = hookv
          else
        ...
        local _242_0 = stack[#stack]
        if (_242_0 == nil) then
          retval, done_3f = v0, true
          return nil
        elseif ((_G.type(_242_0) == "table") and (nil ~= _242_0.prefix)) then
          local prefix = _242_0.prefix
          local source0 = nil
          do
            local _243_0 = table.remove(stack)
            set_source_fields(_243_0)
            source0 = _243_0
          end
          local list = utils.list(utils.sym(prefix, source0), v0)
          return dispatch(utils.copy(source0, list))
        elseif (nil ~= _242_0) then
          local top = _242_0
      ...
      local function badend()
        ...
        do
          local tbl_17_ = {}
          local i_18_ = #tbl_17_
          for _, _245_0 in ipairs(stack) do
            local _246_ = _245_0
            local closer = _246_["closer"]
        ...
        return parse_error(string.format("expected closing delimiter%s %s", _248_, string.char(unpack(closers))), 0)
      end
      ...
      local function parse_comment(b, contents)
        if (b and (10 ~= b)) then
          ...
          return parse_comment(getb(), _251_())
      ...
      local function add_comment_at(comments0, index, node)
        local _255_0 = comments0[index]
        if (nil ~= _255_0) then
          local existing = _255_0
      ...
      local function encode_utf8(codepoint_str)
        local _265_0 = tonumber(codepoint_str:sub(4, -2), 16)
        if (nil ~= _265_0) then
          local codepoint = _265_0
          if _G.utf8 then
      ...
      local function parse_string_loop(chars, b, state)
        ...
        local state0 = nil
        do
          local _269_0 = {state, b}
          if ((_G.type(_269_0) == "table") and (_269_0[1] == "base") and (_269_0[2] == 92)) then
            state0 = "backslash"
          elseif ((_G.type(_269_0) == "table") and (_269_0[1] == "base") and (_269_0[2] == 34)) then
            state0 = "done"
          else
            local _ = _269_0
            state0 = "base"
      ...
      local function expand_str(str)
        ...
        while (i <= #str) do
          ...
          do
            local _272_0 = str:match("^[^\\]+", i)
            if (nil ~= _272_0) then
              local text = _272_0
              add_to_i, add_to_result = #text, text
            else
              local _ = _272_0
              local _273_0 = escapes[str:match("^\\(.?)", i)]
              if (nil ~= _273_0) then
                local escape = _273_0
                ...
                if ("\\\13\n" == str:sub(i, (i + 2))) then
                  ...
                  local _274_0 = str:match("^\\x(%x%x)", i)
                  if (nil ~= _274_0) then
                    local hex_code = _274_0
                    add_to_i, add_to_result = 4, string.char(tonumber(hex_code, 16))
                  else
                    local _1 = _274_0
                    local _275_0 = str:match("^\\u{%x+}", i)
                    if (nil ~= _275_0) then
                      local unicode_escape = _275_0
                      add_to_i, add_to_result = #unicode_escape, encode_utf8(unicode_escape)
                    else
                      local _2 = _275_0
                      local _276_0, _277_0 = str:find("^\\z%s*", i)
                      if (true and (nil ~= _277_0)) then
                        local _3 = _276_0
                        local j = _277_0
                        add_to_i, add_to_result = ((j - i) + 1), ""
                      else
                        local _3 = _276_0
                        local _278_0 = str:match("^\\(%d%d?%d?)", i)
                        if (nil ~= _278_0) then
                          local digits = _278_0
...
package.preload["fennel.utils"] = package.preload["fennel.utils"] or function(...)
  ...
  local function callable_3f(x)
    local function _161_()
      local _160_0 = getmetatable(x)
      if ((_G.type(_160_0) == "table") and true) then
        local __call = _160_0.__call
        return __call
      end
    end
    return ((("function" == type(x)) or _161_()) and x)
  end
  local function multi_sym_3f(str)
    ...
    elseif (type(str) ~= "string") then
      ...
      return ((str:match("%.") or str:match(":")) and not str:match("%.%.") and (str:byte() ~= string.byte(".")) and (str:byte() ~= string.byte(":")) and (str:byte(-1) ~= string.byte(".")) and (str:byte(-1) ~= string.byte(":")) and _163_())
    end
  end
  ...
  root = {chunk = nil, options = nil, reset = _168_, scope = nil}
  root["set-reset"] = function(_169_0)
    local _170_ = _169_0
    local chunk = _170_["chunk"]
    local options = _170_["options"]
    local reset = _170_["reset"]
    local scope = _170_["scope"]
    root.reset = function()
  ...
  local function lua_keyword_3f(str)
    ...
    return (lua_keywords[str] or _172_())
  end
  ...
  local function warn(msg, _3fast, _3ffilename, _3fline, _3fcol)
    ...
    if (nil ~= _177_0) then
      ...
      if (_G.io and _G.io.stderr) then
        local loc = nil
        do
          local _180_0 = ast_source(_3fast)
          if ((_G.type(_180_0) == "table") and (nil ~= _180_0.col) and (nil ~= _180_0.filename) and (nil ~= _180_0.line)) then
            local col = _180_0.col
            local filename = _180_0.filename
            local line = _180_0.line
  ...
  local warned = {}
  local function check_plugin_version(_185_0)
    local _186_ = _185_0
    local plugin = _186_
    local name = _186_["name"]
    local versions = _186_["versions"]
  ...
  local function hook_opts(event, _3foptions, ...)
    ...
    local function _192_(...)
      local _191_0 = root.options
      if (nil ~= _191_0) then
        _191_0 = _191_0.plugins
      end
      return _191_0
    end
    plugins = (_189_(...) or _192_(...))
    if plugins then
      local result = nil
      for _, plugin in ipairs(plugins) do
        if (nil ~= result) then break end
        check_plugin_version(plugin)
        local _194_0 = plugin[event]
        if (nil ~= _194_0) then
          local f = _194_0
          result = f(...)
        else
...
local function eval(str, _3foptions, ...)
  ...
  loader = specials["load-code"](lua_source, env, _955_(...))
  opts.filename = nil
  return loader(...)
end
...
local function syntax()
  ...
  for k, v in pairs(_G) do
    local _956_0 = type(v)
    if (_956_0 == "function") then
      out[k] = {["function?"] = true, ["global?"] = true}
    elseif (_956_0 == "table") then
...
do
    ...
    for i = 1, select("#", binding1, module_name1, ...), 2 do
      ...
      elseif _G["table?"](binding) then
        for macro_name, _43_0 in pairs(binding) do
          ...
          assert(utils["callable?"](macros_2a[macro_name]), ("macro " .. macro_name .. " not found in module " .. tostring(modname) .. "\n" .. view(macros_2a)))
  ...
  local function assert_repl_2a(condition, ...)
    ...
    return setmetatable({filename="src/fennel/macros.fnl", line=407, bytestart=16441, sym('let', nil, {quoted=true, filename="src/fennel/macros.fnl", line=407}), setmetatable({sym('unpack_49_', nil, {filename="src/fennel/macros.fnl", line=407}), setmetatable({filename="src/fennel/macros.fnl", line=407, bytestart=16455, sym('or', nil, {quoted=true, filename="src/fennel/macros.fnl", line=407}), sym('table.unpack', nil, {quoted=true, filename="src/fennel/macros.fnl", line=407}), sym('_G.unpack', nil, {quoted=true, filename="src/fennel/macros.fnl", line=407})}, getmetatable(list())), sym('pack_51_', nil, {filename="src/fennel/macros.fnl", line=408}), setmetatable({filename="src/fennel/macros.fnl", line=408, bytestart=16498, sym('or', nil, {quoted=true, filename="src/fennel/macros.fnl", line=408}), sym('table.pack', nil, {quoted=true, filename="src/fennel/macros.fnl", line=408}), setmetatable({filename=nil, line=nil, bytestart=nil, sym('hashfn', nil, {quoted=true, filename=nil, line=nil}), setmetatable({filename="src/fennel/macros.fnl", line=408, bytestart=16514, sym('doto', nil, {quoted=true, filename="src/fennel/macros.fnl", line=408}), setmetatable({sym('$...', nil, {quoted=true, filename="src/fennel/macros.fnl", line=408})}, {filename="src/fennel/macros.fnl", line=408}), setmetatable({filename="src/fennel/macros.fnl", line=408, bytestart=16527, sym('tset', nil, {quoted=true, filename="src/fennel/macros.fnl", line=408}), "n", setmetatable({filename="src/fennel/macros.fnl", line=408, bytestart=16536, sym('select', nil, {quoted=true, filename="src/fennel/macros.fnl", line=408}), "#", sym('$...', nil, {quoted=true, filename="src/fennel/macros.fnl", line=408})}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list())), sym('vals_50_', nil, {filename="src/fennel/macros.fnl", line=411}), setmetatable({filename="src/fennel/macros.fnl", line=411, bytestart=16709, sym('pack_51_', nil, {filename="src/fennel/macros.fnl", line=411}), condition, ...}, getmetatable(list())), sym('condition_52_', nil, {filename="src/fennel/macros.fnl", line=412}), setmetatable({filename="src/fennel/macros.fnl", line=412, bytestart=16753, sym('.', nil, {quoted=true, filename="src/fennel/macros.fnl", line=412}), sym('vals_50_', nil, {filename="src/fennel/macros.fnl", line=412}), 1}, getmetatable(list())), sym('message_53_', nil, {filename="src/fennel/macros.fnl", line=413}), setmetatable({filename="src/fennel/macros.fnl", line=413, bytestart=16783, sym('or', nil, {quoted=true, filename="src/fennel/macros.fnl", line=413}), setmetatable({filename="src/fennel/macros.fnl", line=413, bytestart=16787, sym('.', nil, {quoted=true, filename="src/fennel/macros.fnl", line=413}), sym('vals_50_', nil, {filename="src/fennel/macros.fnl", line=413}), 2}, getmetatable(list())), "assertion failed, entering repl."}, getmetatable(list()))}, {filename="src/fennel/macros.fnl", line=407}), setmetatable({filename="src/fennel/macros.fnl", line=414, bytestart=16841, sym('if', nil, {quoted=true, filename="src/fennel/macros.fnl", line=414}), setmetatable({filename="src/fennel/macros.fnl", line=414, bytestart=16845, sym('not', nil, {quoted=true, filename="src/fennel/macros.fnl", line=414}), sym('condition_52_', nil, {filename="src/fennel/macros.fnl", line=414})}, getmetatable(list())), setmetatable({filename="src/fennel/macros.fnl", line=415, bytestart=16871, sym('let', nil, {quoted=true, filename="src/fennel/macros.fnl", line=415}), setmetatable({sym('opts_54_', nil, {filename="src/fennel/macros.fnl", line=415}), setmetatable({["assert-repl?"]=true}, {filename="src/fennel/macros.fnl", line=415}), sym('fennel_55_', nil, {filename="src/fennel/macros.fnl", line=416}), setmetatable({filename="src/fennel/macros.fnl", line=416, bytestart=16927, sym('require', nil, {quoted=true, filename="src/fennel/macros.fnl", line=416}), _G["fennel-module-name"]()}, getmetatable(list())), sym('locals_56_', nil, {filename="src/fennel/macros.fnl", line=417}), add_locals(_G["get-scope"](), {})}, {filename="src/fennel/macros.fnl", line=415}), setmetatable({filename="src/fennel/macros.fnl", line=418, bytestart=17023, sym('set', nil, {quoted=true, filename="src/fennel/macros.fnl", line=418}), sym('opts_54_.message', nil, {filename="src/fennel/macros.fnl", line=418}), setmetatable({filename="src/fennel/macros.fnl", line=418, bytestart=17042, sym('fennel_55_.traceback', nil, {filename="src/fennel/macros.fnl", line=418}), sym('message_53_', nil, {filename="src/fennel/macros.fnl", line=418})}, getmetatable(list()))}, getmetatable(list())), setmetatable({filename="src/fennel/macros.fnl", line=419, bytestart=17083, sym('each', nil, {quoted=true, filename="src/fennel/macros.fnl", line=419}), setmetatable({sym('k_57_', nil, {filename="src/fennel/macros.fnl", line=419}), sym('v_58_', nil, {filename="src/fennel/macros.fnl", line=419}), setmetatable({filename="src/fennel/macros.fnl", line=419, bytestart=17096, sym('pairs', nil, {quoted=true, filename="src/fennel/macros.fnl", line=419}), sym('_G', nil, {quoted=true, filename="src/fennel/macros.fnl", line=419})}, getmetatable(list()))}, {filename="src/fennel/macros.fnl", line=419}), setmetatable({filename="src/fennel/macros.fnl", line=420, bytestart=17121, sym('when', nil, {quoted=true, filename="src/fennel/macros.fnl", line=420}), setmetatable({filename="src/fennel/macros.fnl", line=420, bytestart=17127, sym('=', nil, {quoted=true, filename="src/fennel/macros.fnl", line=420}), sym('nil', nil, {quoted=true, filename="src/fennel/macros.fnl", line=420}), setmetatable({filename="src/fennel/macros.fnl", line=420, bytestart=17134, sym('.', nil, {quoted=true, filename="src/fennel/macros.fnl", line=420}), sym('locals_56_', nil, {filename="src/fennel/macros.fnl", line=420}), sym('k_57_', nil, {filename="src/fennel/macros.fnl", line=420})}, getmetatable(list()))}, getmetatable(list())), setmetatable({filename="src/fennel/macros.fnl", line=420, bytestart=17150, sym('tset', nil, {quoted=true, filename="src/fennel/macros.fnl", line=420}), sym('locals_56_', nil, {filename="src/fennel/macros.fnl", line=420}), sym('k_57_', nil, {filename="src/fennel/macros.fnl", line=420}), sym('v_58_', nil, {filename="src/fennel/macros.fnl", line=420})}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list())), setmetatable({filename="src/fennel/macros.fnl", line=421, bytestart=17184, sym('set', nil, {quoted=true, filename="src/fennel/macros.fnl", line=421}), sym('opts_54_.env', nil, {filename="src/fennel/macros.fnl", line=421}), sym('locals_56_', nil, {filename="src/fennel/macros.fnl", line=421})}, getmetatable(list())), setmetatable({filename="src/fennel/macros.fnl", line=422, bytestart=17219, sym('_G.assert', nil, {quoted=true, filename="src/fennel/macros.fnl", line=422}), setmetatable({filename="src/fennel/macros.fnl", line=422, bytestart=17230, sym('fennel_55_.repl', nil, {filename="src/fennel/macros.fnl", line=422}), sym('opts_54_', nil, {filename="src/fennel/macros.fnl", line=422})}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list())), setmetatable({filename="src/fennel/macros.fnl", line=423, bytestart=17262, sym('values', nil, {quoted=true, filename="src/fennel/macros.fnl", line=423}), setmetatable({filename="src/fennel/macros.fnl", line=423, bytestart=17270, sym('unpack_49_', nil, {filename="src/fennel/macros.fnl", line=423}), sym('vals_50_', nil, {filename="src/fennel/macros.fnl", line=423}), 1, sym('vals_50_.n', nil, {filename="src/fennel/macros.fnl", line=423})}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list()))
  end
