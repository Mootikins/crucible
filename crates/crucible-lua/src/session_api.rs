...
pub enum SessionCommand {
    ...
    SetMaxIterations(Option<u32>, oneshot::Sender<Result<(), String>>),
    GetMaxIterations(oneshot::Sender<Option<u32>>),
    SetExecutionTimeout(Option<u64>, oneshot::Sender<Result<(), String>>),
    GetExecutionTimeout(oneshot::Sender<Option<u64>>),
