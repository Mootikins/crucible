...
**Location**: `./crucible/crates/crucible-daemon/tests/tool_registry.rs`
**Total Tests**: 13
...
```rust
// In ./crucible/crates/crucible-daemon/src/tools/mod.rs
...
Check the detailed guide: `./crucible/crates/crucible-daemon/tests/TOOL_REGISTRY_TEST_GUIDE.md`
