...
use crate::storage::sqlite::query::error::ParseError;
use crate::storage::sqlite::query::ir::{
    EdgeDirection, EdgePattern, GraphIR, PatternElement, QuerySource,
};
use crate::storage::sqlite::query::syntax::QuerySyntax;
    ...
    fn parse(&self, input: &str) -> Result<GraphIR, ParseError> {
        ...
        if let Some(caps) = SQL_GRAPH_RE.captures(input) {
            ...
            return Ok(GraphIR {
                ...
                pattern: crate::storage::sqlite::query::ir::GraphPattern {
