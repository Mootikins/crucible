...
pub use client::{
    first_per_note, AgentsListCardsRequest, DaemonCapabilities, DaemonClient, FsListDirRequest,
    ...
    LuaShutdownSessionResponse, McpStartRequest, NameRequest, NoteRenameRequest,
    NotificationDismissRequest, NotificationListRequest, PathRequest, PluginInstallRequest,
