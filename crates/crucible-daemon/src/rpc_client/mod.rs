...
pub use client::{
    ...
    SessionCreateRequest, SessionEvent, SessionExportToFileRequest, SessionIdRequest,
    SessionRenderMarkdownRequest, SessionReplayRequest, SessionResumeFromStorageRequest,
