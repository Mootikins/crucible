...
pub use client::{
    ...
    KilnSetClassificationRequest, ListAllModelsRequest, ListProvidersRequest,
    ...
    LuaShutdownSessionResponse, McpStartRequest, NameRequest, NoteRenameRequest, PathRequest,
    PluginInstallRequest, PluginOptionCallRequest, PluginOptionsRequest, PluginPublicationsRequest,
    PluginRemoveRequest, PluginRunCommandRequest, PluginTestFailure, PluginTestLoadFailure,
    ProcessFileRequest, ReviewCommentRequest, ReviewResolveCommentRequest, ReviewSetStateRequest,
    ScmCloneRequest, SearchVectorsRequest, SessionAgentSpec, SessionConfigureAgentRequest,
    SessionCreateParams, SessionCreateRequest, SessionDismissNotificationRequest, SessionEvent,
