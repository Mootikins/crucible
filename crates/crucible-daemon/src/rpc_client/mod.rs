...
pub use client::{
    ...
    McpStartRequest, NameRequest, PluginTestFailure, PluginTestLoadFailure, SessionAgentSpec,
    SessionCreateParams, SessionCreateRequest, SessionEvent, SkillsGetRequest, SkillsListRequest,
