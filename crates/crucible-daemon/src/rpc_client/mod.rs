...
pub use client::{
    ...
    PluginViewRequest, ProcessFileRequest, ReviewCommentRequest, ReviewResolveCommentRequest,
    ReviewSetStateRequest, ScmCloneRequest, SearchVectorsRequest, SessionAgentSpec,
