...
async fn test_store_and_retrieve_embedding() {
    ...
    // Store embedding
    db.store_embedding("test.md", "Test content", &embedding, &metadata)
        .await
        .unwrap();
...
async fn test_update_existing_embedding() {
    ...
    db.store_embedding("test.md", "Content 1", &embedding1, &metadata)
        .await
        .unwrap();

    // Update with second embedding
    db.store_embedding("test.md", "Content 2", &embedding2, &metadata)
        .await
        .unwrap();
...
async fn test_list_files() {
    ...
    db.store_embedding("file1.md", "Content 1", &embedding, &metadata)
        .await
        .unwrap();
    db.store_embedding("file2.md", "Content 2", &embedding, &metadata)
        .await
        .unwrap();
...
async fn test_similarity_search() {
    ...
    // Store embeddings
    db.store_embedding("file1.md", "Content 1", &embedding1, &metadata)
        .await
        .unwrap();
    db.store_embedding("file2.md", "Content 2", &embedding2, &metadata)
        .await
        .unwrap();
    db.store_embedding("file3.md", "Content 3", &embedding3, &metadata)
        .await
        .unwrap();
...
async fn test_search_by_tags() {
    ...
    db.store_embedding("file1.md", "Content 1", &embedding, &metadata1)
        .await
        .unwrap();
    db.store_embedding("file2.md", "Content 2", &embedding, &metadata2)
        .await
        .unwrap();
