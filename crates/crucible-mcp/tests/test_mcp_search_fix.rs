...
impl McpTestClient {
    ...
    async fn spawn() -> Result<Self> {
        ...
        cmd.env("EMBEDDING_ENDPOINT", "https://llm.example.com");
        cmd.env("OBSIDIAN_VAULT_PATH", "~/Documents/crucible-testing");
...
async fn test_mcp_search_tools_fix() -> Result<()> {
    ...
    let indexed_count = client.build_search_index("~/Documents/crucible-testing").await?;
