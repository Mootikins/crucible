...
pub use crate::kiln_integration::{
    ...
    get_all_document_embeddings, get_document_chunk_hashes, get_document_embeddings,
    get_embedding_by_content_hash, get_embedding_index_metadata, store_document_embedding,
    store_embedding, store_embedding_with_chunk_id, store_embeddings_batch, EmbeddingIndexMetadata,
};
