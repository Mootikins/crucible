...
mod tests {
    ...
    fn test_small_models() {
        assert_eq!(
            ModelSize::from_model_name("granite-micro-3b-q6_k"),
            ModelSize::Small
        );
    ...
    fn test_medium_models() {
        assert_eq!(
            ModelSize::from_model_name("qwen3-4b-instruct"),
            ModelSize::Medium
        );
        assert_eq!(
            ModelSize::from_model_name("granite-tiny-7b"),
            ModelSize::Medium
        );
        assert_eq!(
            ModelSize::from_model_name("deepseek-r1-8b"),
            ModelSize::Medium
        );
    ...
    fn test_large_models() {
        assert_eq!(
            ModelSize::from_model_name("qwen2.5-coder-32b"),
            ModelSize::Large
        );
    ...
    fn test_unknown_defaults_to_medium() {
        assert_eq!(
            ModelSize::from_model_name("unknown-model"),
            ModelSize::Medium
        );
