export enum CLASSES {
  ...
  FLEXLAYOUT__FLOATING_PANEL = "flexlayout__floating_panel",
  FLEXLAYOUT__FLOATING_PANEL_TITLEBAR = "flexlayout__floating_panel_titlebar",
  FLEXLAYOUT__FLOATING_PANEL_TITLEBAR_TITLE = "flexlayout__floating_panel_titlebar_title",
  FLEXLAYOUT__FLOATING_PANEL_TITLEBAR_BUTTONS = "flexlayout__floating_panel_titlebar_buttons",
  FLEXLAYOUT__FLOATING_PANEL_CONTENT = "flexlayout__floating_panel_content",
  FLEXLAYOUT__FLOATING_PANEL_RESIZE_HANDLE = "flexlayout__floating_panel_resize_handle",
  FLEXLAYOUT__FLOATING_PANEL_RESIZE_N = "flexlayout__floating_panel_resize_n",
  FLEXLAYOUT__FLOATING_PANEL_RESIZE_S = "flexlayout__floating_panel_resize_s",
  FLEXLAYOUT__FLOATING_PANEL_RESIZE_E = "flexlayout__floating_panel_resize_e",
  FLEXLAYOUT__FLOATING_PANEL_RESIZE_W = "flexlayout__floating_panel_resize_w",
  FLEXLAYOUT__FLOATING_PANEL_RESIZE_NE = "flexlayout__floating_panel_resize_ne",
  FLEXLAYOUT__FLOATING_PANEL_RESIZE_NW = "flexlayout__floating_panel_resize_nw",
  FLEXLAYOUT__FLOATING_PANEL_RESIZE_SE = "flexlayout__floating_panel_resize_se",
  FLEXLAYOUT__FLOATING_PANEL_RESIZE_SW = "flexlayout__floating_panel_resize_sw",
  FLEXLAYOUT__FLOATING_PANEL_OUTLINE = "flexlayout__floating_panel_outline",
  ...
  FLEXLAYOUT__BORDER__HIDDEN = "flexlayout__border--hidden",
