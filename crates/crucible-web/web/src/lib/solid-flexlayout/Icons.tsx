...
const style: JSX.CSSProperties = { width: "1em", height: "1em", display: "flex", "align-items": "center" };
...
export const OverflowIcon: Component = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" style={style} viewBox="0 0 24 24" fill="var(--color-icon)">
            <path d="M0 0h24v24H0z" fill="none" />
...
export const EdgeIcon: Component = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" style={{ display: "block", width: "10px", height: "10px" }} preserveAspectRatio="none" viewBox="0 0 100 100">
            <path fill="var(--color-edge-icon)" stroke="var(--color-edge-icon)" d="M10 30 L90 30 l-40 40 Z" />
        </svg>
    );
};

export const PopoutIcon: Component = () => {
    return (
...
export const AsterickIcon: Component = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" style={style} height="24px" viewBox="0 -960 960 960" width="24px">
            <path fill="var(--color-icon)" stroke="var(--color-icon)" d="M440-120v-264L254-197l-57-57 187-186H120v-80h264L197-706l57-57 186 187v-264h80v264l186-187 57 57-187 186h264v80H576l187 186-57 57-186-187v264h-80Z" />
        </svg>
    );
};
