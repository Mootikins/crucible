...
impl RuneAstAnalyzer {
    ...
    fn extract_functions_from_unit(&self, unit: &Arc<rune::Unit>) -> Result<Vec<AsyncFunctionInfo>> {
    ...
    pub fn analyze_function(&self, unit: &Arc<rune::Unit>, function_path: &[&str]) -> Result<Option<AsyncFunctionInfo>> {
    ...
    pub fn generate_function_schema(&self, function: &AsyncFunctionInfo) -> Result<Value> {
        ...
        Ok(json!({
            ...
            "required": required,
            "description": function.description.unwrap_or_else(|| format!("{} function", function.name))
        }))
    }
    ...
    pub fn validate_function(&self, function: &AsyncFunctionInfo) -> Result<super::ValidationResult> {
    ...
    pub fn infer_function_metadata(&self, function: &AsyncFunctionInfo) -> HashMap<String, Value> {
...
mod tests {
    ...
    fn test_function_validation() {
        ...
        let function = AsyncFunctionInfo {
            ...
            doc_comments: Vec::new(),
            location: super::SourceLocation { line: 1, column: 1, offset: 0 },
            metadata: HashMap::new(),
            attributes: Vec::new(),
        };
