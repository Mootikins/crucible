...
//! LLAMA_BASE_URL=https://llm.example.com/v1 cargo test -p crucible-rig --test model_contract_tests -- --ignored --nocapture
//!
...
impl ModelTestConfig {
    fn from_env() -> Self {
        ...
        let base_url = std::env::var("LLAMA_BASE_URL")
            ...
            .unwrap_or_else(|_| "https://llm.example.com/v1".to_string());
