...
pub use agent::{
    ...
    build_agent_with_model_size, build_agent_with_tools, AgentBuildError, AgentComponents,
    AgentConfig, BuiltAgent,
};
...
pub use providers::{
    create_client, create_openai_compat_client, HandleBuildOpts, RigClient, RigError, RigResult,
};
pub use session::{
