...
pub struct UpstreamServerConfig {
    ...
    /// Required prefix for tool names (e.g., "gh_" for github tools).
    pub prefix: String,
...
"#;
        ...
        assert_eq!(gh.prefix, "gh_");
        assert!(gh.auto_reconnect);
        assert_eq!(gh.timeout_secs, 30);
