...
// Import our new clean component configs
use crucible_config::{
    Config as CrucibleConfig, CliConfig as NewCliConfig, EmbeddingConfig,
    AcpConfig, ChatConfig
};
...
/// CLI configuration - now a simple wrapper around our component system
...
"#;
    ...
    pub fn ollama_endpoint(&self) -> String {
        self.llm
            ...
            .endpoint
            .clone()
            .unwrap_or_else(|| "https://llm.example.com".to_string())
    }
...
"#;
    ...
    fn test_new_embedding_config_ollama() {
        ...
        config.embedding = Some(EmbeddingConfigSection {
            ...
            ollama: OllamaEmbeddingOptions {
                url: Some("https://llm.example.com".to_string()),
    ...
    fn test_legacy_embedding_config_ollama() {
        let mut config = CliConfig::default();
        config.kiln.embedding_url = "https://llm.example.com".to_string();
