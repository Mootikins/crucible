//! 2D cell grid for multi-line flex layout rendering.
//!
//! When row children produce multi-line output, the standard string-based
//! rendering breaks alignment. CellGrid provides proper 2D positioning.
