...
mod tests {
    ...
    fn different_frames_produce_different_cipher() {
        ...
        let frame0_stripped = strip_ansi(&frame0);
        let frame1_stripped = strip_ansi(&frame1);
