...
- `./crucible/crates/crucible-llm/tests/mock_embedding_provider_tests.rs` - Comprehensive test suite
- `./crucible/crates/crucible-llm/tests/MOCK_PROVIDER_TEST_PLAN.md` - This documentation
