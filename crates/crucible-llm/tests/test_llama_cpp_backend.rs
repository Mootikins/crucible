...
mod tests {
    ...
    const NOMIC_EMBED_MODEL: &str = "~/models/language/nomic-ai/nomic-embed-text-v1.5-GGUF/nomic-embed-text-v1.5.Q8_0.gguf";

    /// Alternative: nomic-embed-text v2 MoE model (newer, may work better)
    const NOMIC_EMBED_V2_MODEL: &str = "~/models/language/nomic-ai/nomic-embed-text-v2-moe-GGUF/nomic-embed-text-v2-moe.Q4_K_M.gguf";
