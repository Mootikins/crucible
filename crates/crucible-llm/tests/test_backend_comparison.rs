...
mod llama_cpp_tests {
    ...
    const NOMIC_V15_MODEL: &str = "~/models/language/nomic-ai/nomic-embed-text-v1.5-GGUF/nomic-embed-text-v1.5.Q8_0.gguf";
    const NOMIC_V2_MODEL: &str = "~/models/language/nomic-ai/nomic-embed-text-v2-moe-GGUF/nomic-embed-text-v2-moe.Q4_K_M.gguf";
