...
impl ProviderType {
    ...
    pub fn default_endpoint(&self) -> &'static str {
        match self {
            ProviderType::Ollama => "https://llm.example.com",
...
impl EmbeddingConfig {
    ...
    pub fn ollama(endpoint: Option<String>, model: Option<String>) -> Self {
        Self {
            ...
            endpoint: endpoint.unwrap_or_else(|| "https://llm.example.com".to_string()),
            api_key: None,
...
mod tests {
    ...
    fn test_provider_defaults() {
        ...
        assert_eq!(ollama.default_endpoint(), "https://llm.example.com");
