//! Supporting types for embedding providers (EmbeddingResponse, ModelInfo, etc.)
//!
//! The canonical `EmbeddingProvider` trait is defined in
//! `crucible_core::enrichment::EmbeddingProvider`.
...
// All providers implement that trait directly. This module retains the supporting types
// (EmbeddingResponse, ModelInfo, etc.) used by implementations.
