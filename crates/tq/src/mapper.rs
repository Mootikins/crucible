...
//!
//! ```rust,ignore
//! use tq::mapper::{MapperRegistry, JqMapper};
//!
...
pub trait Mapper: Send + Sync {
    ...
    fn transform(&self, value: Value) -> Result<Value, TqError>;
...
impl JqMapper {
    ...
    pub fn new(expression: &str) -> Result<Self, TqError> {
...
impl Mapper for ChainMapper {
    fn transform(&self, mut value: Value) -> Result<Value, TqError> {
...
impl MapperRegistry {
    ...
    pub fn transform(&self, tool_name: &str, value: Value) -> Result<Value, TqError> {
...
pub fn default_registry() -> Result<MapperRegistry, TqError> {
    let mut registry = MapperRegistry::new();
