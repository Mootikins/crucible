...
impl ContentFormatter {
    ...
    pub fn format(&self, value: &Value) -> Result<String, TqError> {
        match value {
    ...
    fn format_object(&self, map: &serde_json::Map<String, Value>) -> Result<String, TqError> {
    ...
    fn format_array(&self, arr: &[Value]) -> Result<String, TqError> {
    ...
    fn format_simple(&self, value: &Value) -> Result<String, TqError> {
