...
- **File**: `./crucible/crates/crucible-cli/src/common/daemon_manager.rs`
...
- **File**: `./crucible/crates/crucible-cli/src/commands/semantic.rs`
- **Workflow**:
...
- **File**: `./crucible/test_integration.sh`
- **Coverage**:
  - Embedding detection
  - Daemon triggering
  - Progress feedback
