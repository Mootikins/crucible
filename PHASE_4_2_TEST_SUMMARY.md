...
**Location**: `./crucible/crates/crucible-services/src/types/tests.rs`
...
- `./crucible/crates/crucible-services/src/types/tests.rs` (new)
- `./crucible/crates/crucible-tools/src/tests/basic_tests.rs` (new)
- `./crucible/crates/crucible-tools/src/tests/tool_tests.rs` (new)
- `./crucible/crates/crucible-tools/src/tests/registry_tests.rs` (new)
- `./crucible/crates/crucible-tools/src/tests/integration_tests.rs` (new)
- `./crucible/crates/crucible-tools/src/tests/mod.rs` (new)
- `./crucible/crates/crucible-tools/src/lib.rs` (modified)
