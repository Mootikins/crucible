...
async fn test_migration_status_command_with_validation() -> Result<()> {
    ...
    assert!(
        result.is_ok(),
        "Migration status with validation should succeed"
    );
...
async fn test_migration_status_command_disabled_migration() -> Result<()> {
    ...
    assert!(
        result.is_ok(),
        "Status command should handle disabled migration gracefully"
    );
...
async fn test_migration_list_command_inactive_only() -> Result<()> {
    ...
    assert!(
        result.is_ok(),
        "Inactive-only migration list should succeed"
    );
...
async fn test_migration_list_command_with_metadata() -> Result<()> {
    ...
    assert!(
        result.is_ok(),
        "Migration list with metadata should succeed"
    );
...
async fn test_migration_validate_command_with_auto_fix() -> Result<()> {
    ...
    assert!(
        result.is_ok(),
        "Migration validate with auto-fix should succeed"
    );
...
async fn test_migration_migrate_command_dry_run_specific() -> Result<()> {
    ...
    assert!(
        result.is_ok(),
        "Dry run migration of specific tool should succeed"
    );
...
async fn test_migration_migrate_command_different_security_levels() -> Result<()> {
    ...
    for security_level in ["safe", "development", "production"] {
        ...
        assert!(
            result.is_ok(),
            "Migration with security level '{}' should succeed",
            security_level
        );
    }
...
async fn test_migration_rollback_command_disabled_migration() -> Result<()> {
    ...
    assert!(
        result.is_err(),
        "Rollback should fail when migration is disabled"
    );
...
async fn test_migration_reload_command_disabled_migration() -> Result<()> {
    ...
    assert!(
        result.is_err(),
        "Reload should fail when migration is disabled"
    );
...
async fn test_migration_cleanup_command_inactive() -> Result<()> {
    ...
    assert!(
        result.is_ok(),
        "Cleanup of inactive migrations should succeed"
    );
...
async fn test_migration_cleanup_command_failed() -> Result<()> {
    ...
    assert!(
        result.is_ok(),
        "Cleanup of failed migrations should succeed"
    );
...
async fn test_migration_cleanup_command_both() -> Result<()> {
    ...
    assert!(
        result.is_ok(),
        "Cleanup of both inactive and failed migrations should succeed"
    );
...
async fn test_migration_cleanup_command_disabled_migration() -> Result<()> {
    ...
    assert!(
        result.is_err(),
        "Cleanup should fail when migration is disabled"
    );
...
async fn test_migration_integration_with_mock_bridge() -> Result<()> {
    ...
    assert!(
        result.is_ok(),
        "Status command should work with mock bridge"
    );
    ...
    assert!(
        result.is_ok(),
        "Validation command should work with mock bridge"
    );
...
async fn test_migration_commands_with_invalid_parameters() -> Result<()> {
    ...
    assert!(
        result.is_ok(),
        "Should handle invalid security level gracefully"
    );
...
async fn test_migration_commands_with_invalid_format() -> Result<()> {
    ...
    assert!(
        result.is_ok(),
        "Should handle invalid format gracefully in list"
    );
    ...
    assert!(
        result.is_ok(),
        "Should handle invalid format gracefully in validation"
    );
...
async fn test_concurrent_migration_commands() -> Result<()> {
    ...
    let (status_result, list_result, validate_result) =
        tokio::join!(status_future, list_future, validate_future);

    assert!(
        status_result.is_ok(),
        "Concurrent status command should succeed"
    );
    assert!(
        list_result.is_ok(),
        "Concurrent list command should succeed"
    );
    assert!(
        validate_result.is_ok(),
        "Concurrent validation command should succeed"
    );
