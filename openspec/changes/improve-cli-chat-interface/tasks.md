...
- [ ] 1.1 Remove boxes from startup messages in chat.rs
- [ ] 1.2 Remove boxes from agent response display
- [ ] 1.3 Implement clean message formatting with minimal separators
- [ ] 1.4 Add subtle visual hierarchy with indentation and spacing
...
- [ ] 4.1 Show tool calls during agent execution
...
## 5. Mode Management
- [ ] 5.1 Add auto-approve mode with visual indicators
- [ ] 5.2 Implement Shift+Tab hotkey for mode switching
- [ ] 5.3 Add mode status display in chat prompt
...
- [ ] 6.6 Add `/mode` command for unified mode switching
