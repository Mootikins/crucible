...
**Files to Fix:**
- `./crucible-fix-process-pipeline/crates/crucible-pipeline/tests/pipeline_integration_tests.rs`
...
**File Modified:** `./crucible-fix-process-pipeline/crates/crucible-cli/src/config.rs`
