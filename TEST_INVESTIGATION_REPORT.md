...
The bug is in the **order of operations** in `./crucible/crates/crucible-parser/src/block_extractor.rs` at **lines 208-223**.
...
### File: `./crucible/crates/crucible-parser/src/block_extractor.rs`
