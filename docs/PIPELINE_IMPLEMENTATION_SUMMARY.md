...
**File**: `./docs/ASYNC_PIPELINE_ARCHITECTURE.md`
...
**Files**:
- `./crucible/crates/crucible-core/src/parser/types.rs` (467 lines)
- `./crucible/crates/crucible-core/src/parser/traits.rs` (267 lines)
- `./crucible/crates/crucible-core/src/parser/error.rs` (88 lines)
- `./crucible/crates/crucible-core/src/parser/mod.rs` (13 lines)
...
**Files**:
- `./crucible/crates/crucible-core/src/sink/traits.rs` (253 lines)
- `./crucible/crates/crucible-core/src/sink/error.rs` (115 lines)
- `./crucible/crates/crucible-core/src/sink/circuit_breaker.rs` (410 lines)
- `./crucible/crates/crucible-core/src/sink/mod.rs` (11 lines)
...
**Modified files**:
- `./crucible/crates/crucible-core/src/lib.rs`: Added module exports
- `./crucible/crates/crucible-core/Cargo.toml`: Added `toml = "0.8"` dependency
...
**Files**:
- Architecture: `./docs/ASYNC_PIPELINE_ARCHITECTURE.md`
- Parser types: `./crucible/crates/crucible-core/src/parser/`
- Sink types: `./crucible/crates/crucible-core/src/sink/`
