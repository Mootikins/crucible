...
**Severity**: Minor
**File**: `./crucible-fix-process-pipeline/crates/crucible-cli/src/factories/watch.rs:25`
**Issue**:
```rust
pub fn create_file_watcher(_config: &CliConfig) -> Result<Arc<dyn FileWatcher>>
```
...
**Severity**: Minor
**Files**:
- `./crucible-fix-process-pipeline/crates/crucible-cli/src/commands/process.rs:248-269`
- `./crucible-fix-process-pipeline/crates/crucible-cli/src/commands/chat.rs:380-401`
