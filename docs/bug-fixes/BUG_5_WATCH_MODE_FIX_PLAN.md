...
1. **`./crucible-fix-process-pipeline/crates/crucible-watch/src/traits.rs`**
   - Lines ~15-30: `FileWatcher` trait definition
   - Change: Add event sender parameter to `watch()` method
   - Remove: `set_event_sender()` method

2. **`./crucible-fix-process-pipeline/crates/crucible-watch/src/manager.rs`**
...
3. **`./crucible-fix-process-pipeline/crates/crucible-cli/src/commands/process.rs`**
...
4. **`./crucible-fix-process-pipeline/crates/crucible-cli/src/factories/watch.rs`**
   - New file or existing factory
   - Change: Remove `set_event_sender()` call from factory

### Test Files to Create/Modify:
1. **`./crucible-fix-process-pipeline/crates/crucible-watch/tests/watch_integration_test.rs`**
