...
**Files Affected:**
- `./crucible-fix-process-pipeline/crates/crucible-surrealdb/src/change_detection_store.rs`
...
**Files Affected:**
- `./crucible-fix-process-pipeline/crates/crucible-cli/src/commands/process.rs` (lines 152-242)
- `./crucible-fix-process-pipeline/crates/crucible-watch/src/manager.rs`
- `./crucible-fix-process-pipeline/crates/crucible-watch/src/traits.rs`
