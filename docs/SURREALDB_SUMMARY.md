...
### 2. SurrealQL Schema
**File**: `./crucible/crates/crucible-surrealdb/src/schema.surql`
...
**File**: `./crucible/crates/crucible-surrealdb/src/schema_types.rs`
...
### 4. Query Examples
**File**: `./crucible/crates/crucible-surrealdb/examples/queries.surql`
...
**File**: `./docs/SURREALDB_IMPLEMENTATION.md`
...
- `./docs/SURREALDB_SCHEMA.md` - Design doc
- `./docs/SURREALDB_IMPLEMENTATION.md` - Implementation guide
- `./crucible/crates/crucible-surrealdb/src/schema.surql` - Schema
- `./crucible/crates/crucible-surrealdb/src/schema_types.rs` - Rust types
- `./crucible/crates/crucible-surrealdb/examples/queries.surql` - Query examples
