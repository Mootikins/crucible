...
See: `./crucible/crates/crucible-rune/src/struct_plugin.rs`
...
- Crucible source code:
  - `./crucible/crates/crucible-rune/src/struct_plugin.rs`
  - `./crucible/crates/crucible-rune/src/plugin_types.rs`
  - `./crucible/examples/plugins/just.rn`
