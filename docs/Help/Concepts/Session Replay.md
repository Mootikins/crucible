...
- [[Help/Concepts/Kilns]] - Where sessions and notes live
- [[Help/Concepts/Plaintext First]] - Why recordings use a text-based format
- [[Help/Concepts/Agent Client Protocol]] - ACP sessions can be recorded too
