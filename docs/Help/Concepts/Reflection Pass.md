...
- **Exposure:** when a session opens, the startup banner says how many proposals are pending in the kiln the CLI reads. Each pass also writes the count to the daemon log when it stages a file.
