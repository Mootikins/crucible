...
Edit `./crucible/crates/crucible-parser/src/types.rs`:
...
Edit `./crucible/crates/crucible-parser/src/lib.rs`:
...
Check `./crucible/crates/crucible-parser/Cargo.toml`:
...
Edit `./crucible/crates/crucible-core/src/parser/mod.rs`:
