...
class AgentSymlinkManager:
    ...
    def cleanup_global_agents(self):
        ...
        global_agents_path = Path("~/.agents")
...
def main():
    ...
    parser.add_argument("--project-root", default="./crucible",
                       help="Path to project root (default: ./crucible)")
    parser.add_argument("--global-agents-root", default="~/dotfiles/agents",
                       help="Path to global agents root (default: ~/dotfiles/agents)")
