...
Semantic search requires an embedding provider. See [embedding](../config/embedding/) for setup options including:
- Local (Ollama, FastEmbed)
- Cloud (OpenAI)

## See Also

- [search](../cli/search/) - Search command reference
- Search & Discovery - All search methods
- [The Knowledge Graph](./the-knowledge-graph/) - How links complement search
