...
3. **Choose a structure** - See [Index](../help/cli/index/)
4. **Learn commands** - Read [Basic Commands](./basic-commands/)
5. **Configure agents** - Explore [agents](../help/config/agents/)
...
- [Basic Commands](./basic-commands/) - Essential CLI commands
- [Index](../help/cli/index/) - Structuring your kiln
