...
See [Creating Plugins](../extending/creating-plugins/) for writing your own plugins.
...
- [Scripting Languages](../concepts/scripting-languages/) - Overview of Lua in Crucible
- [Creating Plugins](../extending/creating-plugins/) - Writing Lua plugins
