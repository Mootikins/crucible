...
See [Workflow Syntax](./workflow-syntax/) for the full syntax reference.
...
- [Workflow Syntax](./workflow-syntax/) — full syntax reference
- [Workflow Authoring](../extending/workflow-authoring/) — authoring workflows
- Extending Crucible — all extension points
- [Event Hooks](../extending/event-hooks/) — triggering workflows from events
