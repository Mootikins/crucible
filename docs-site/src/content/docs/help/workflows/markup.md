...
- [Index](./index/) - Workflow overview
- [Sessions](../core/sessions/) - Session tracking (orthogonal to workflows)
- [Workflow Authoring](../extending/workflow-authoring/) - Current YAML format
