...
Rules files are loaded hierarchically from git root to workspace directory. See [Rules Files](./rules-files/) for details.
...
See [MCP Configuration](./config/mcp/) for full details.
...
- [MCP Configuration](./config/mcp/) - Upstream MCP server setup
- [LLM Configuration](./config/llm/) - Language model providers
- [Embedding Configuration](./config/embedding/) - Text embeddings
- [Workspace Configuration](./config/workspaces/) - Multi-workspace setup
- [Rules Files](./rules-files/) - Project-specific agent instructions
- [Internal Agent](./extending/internal-agent/) - Built-in agent configuration
