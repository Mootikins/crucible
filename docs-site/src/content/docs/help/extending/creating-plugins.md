...
> **Note:** Agents and workflows are defined separately as markdown templates in `.crucible/agents/` and `.crucible/workflows/`. They use the tools that plugins provide. See [Agent Cards](./agent-cards/) and [Index](../workflows/index/).
...
See [workspaces](../config/workspaces/) for full security configuration.
...
Fennel files are compiled to Lua at load time. See [Language Basics](../lua/language-basics/) for more on the Lua ecosystem.
...
See [Task Management](../task-management/) for a complete example plugin that demonstrates:
...
- [Plugin Manifest](./plugin-manifest/) - Manifest format and programmatic API
- [Language Basics](../lua/language-basics/) - Lua syntax
- [Configuration](../lua/configuration/) - Lua configuration
- [Event Hooks](./event-hooks/) - Hook system
- [Custom Tools](./custom-tools/) - Tool deep dive
- [Scripted UI](./scripted-ui/) - cru.oil UI building
- [workspaces](../config/workspaces/) - Workspace and security configuration
