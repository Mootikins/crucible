...
The child runs as a real (hidden) session: the card's system prompt, tool policy, and model, with Precognition and session persistence. See [Delegation](../concepts/delegation/).
...
- [Delegation](../concepts/delegation/) - Delegating tasks to other agents
- [chat](../cli/chat/) - Chat command
- AI Features - All AI capabilities
- [Agents & Protocols](../concepts/agents-and-protocols/) - MCP/ACP explained
