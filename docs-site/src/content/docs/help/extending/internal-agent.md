...
Crucible's internal agent is a built-in AI assistant that runs locally, logs sessions as markdown, and uses your kiln as its memory. Unlike external agents via [ACP](../concepts/agents-and-protocols/), the internal agent has direct access to your files and can persist state across sessions.
...
fire. See [Event Hooks](./event-hooks/) for each one's payload and return
contract.
...
- [Agent Cards](./agent-cards/) - Define agent personas
- [Event Hooks](./event-hooks/) - React to agent events
- [Custom Tools](./custom-tools/) - Add tools for agents
- [Agents & Protocols](../concepts/agents-and-protocols/) - MCP vs ACP
- [Language Basics](../lua/language-basics/) - Lua scripting
