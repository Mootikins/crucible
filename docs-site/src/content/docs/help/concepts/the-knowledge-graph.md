...
- Hub notes (like [Index](../cli/index/)) help navigation
- You'll notice patterns in how you think

## See Also

- [Wikilinks](../wikilinks/) - Link syntax reference
- [Block References](../block-references/) - Linking to specific paragraphs
