...
With Precognition turned on, your [knowledge graph](./the-knowledge-graph/) becomes the agent's long-term memory. Notes you wrote months ago can surface in today's conversation if they're relevant. The more you write, the smarter your agent gets.
...
**Use wikilinks.** Links between notes strengthen the [knowledge graph](./the-knowledge-graph/). When Precognition finds one note, related linked notes become easier to surface too.
...
- [Semantic Search](./semantic-search/) - How meaning-based search works
- [The Knowledge Graph](./the-knowledge-graph/) - How wikilinks create structure
- [Plaintext First](./plaintext-first/) - Why markdown files are the source of truth
