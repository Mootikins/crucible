...
- [Semantic search](./semantic-search/) is enabled (Precognition)
...
Skills are delivered to agents through the [ACP](./agent-client-protocol/) session lifecycle:
...
- [Agent Client Protocol](./agent-client-protocol/): ACP spec (protocol that delivers skills)
- [Agents & Protocols](./agents-and-protocols/): overview of agent architecture
- [Semantic Search](./semantic-search/): how Precognition augments skill context
- [skills](../cli/skills/): skills command reference
