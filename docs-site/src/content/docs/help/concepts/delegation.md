...
You can delegate to any [Agent Client Protocol](./agent-client-protocol/) agent that Crucible knows about. Built-in agents include:
...
- [Agent Client Protocol](./agent-client-protocol/) for the underlying protocol
