...
When an agent [delegates](./delegation/) a task to another agent, trust checks apply to the child session too. The delegated agent must have sufficient trust for the kiln's classification.
...
- [Delegation](./delegation/) for how trust propagates through agent chains
- [Kilns](./kilns/) for kiln basics and setup
- [Agent Client Protocol](./agent-client-protocol/) for the protocol agents use to communicate
