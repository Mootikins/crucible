...
See [Modes](./modes/) for details on what each mode does.
...
**Thinking Budget:** Configure via `:set thinkingbudget=<value>` or use presets like `high`, `medium`, `low`. See [Commands](./commands/) for details.
...
- `!` opens a [shell modal](./shell-execution/) with streaming output

## See Also

- [Commands](./commands/) - REPL commands (`:set`, `:model`, etc.)
- [Shell Execution](./shell-execution/) - Shell Execution
- [Index](./index/) - TUI Overview
