...
Modes control what actions an agent can take at runtime. They act as a permission layer on top of [agent cards](../extending/agent-cards/).
...
The status bar layout is configurable via Lua — see [Configuration](../lua/configuration/).
...
- [Agent Cards](../extending/agent-cards/) - Configuring agent permissions
